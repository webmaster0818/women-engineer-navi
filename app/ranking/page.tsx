...
export const metadata: Metadata = {
  ...
  description:
    "9社すべて求人数・実績を各社公式サイトで確認した現行値だけで比較（2026年7月更新）。IT特化・女性特化・未経験向け・フルリモート特化まで状況別に整理し、8つの質問の無料診断で自分に合う1社を30秒で絞り込めます。口コミはすべて出典つき・架空なし。",
  keywords:
      ...
      <section className="section-primary-light py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="mt-6 text-sm text-text-light">
            最終更新: 2026年7月18日 | 比較対象: 9社 | 比較基準: 6項目
          </p>
        </div>
      </section>
