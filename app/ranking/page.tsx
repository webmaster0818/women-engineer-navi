...
export const metadata: Metadata = {
  title:
    "【2026年最新】女性エンジニアにおすすめの転職エージェント・転職サイト9選を徹底比較",
  description:
    "女性エンジニアにおすすめの転職エージェント9社を徹底比較。産休育休取得率・リモートワーク率・女性アドバイザー有無など独自基準でランキング。IT特化型から女性特化型まで、あなたに最適なエージェントが見つかります。",
  keywords:
...
const agents: Agent[] = [
  ...
  },
  {
    ...
    description:
      "Geekly（ギークリー）は、IT・Web・ゲーム業界に特化した転職エージェントです。46,000件以上（非公開含む・2026年6月時点の公式公開値）の求人を保有しています。業界に精通したコンサルタントが在籍しており、企業ごとにカスタマイズした書類添削をサポートしています。女性エンジニアの転職にも対応しており、リモートワーク対応求人の割合は公式サイトでご確認ください。長期的なキャリア形成を考える女性エンジニアに適しています。",
    detailedReview:
      "Geeklyの最大の魅力は独占求人の多さです。他のエージェントでは出会えない優良企業の求人が多く、特にメガベンチャーやゲーム業界の求人に強みがあります。コンサルタントはIT業界出身者が多く、技術的な会話がスムーズにできる点も評価が高いです。書類添削サービスでは、企業ごとにカスタマイズした職務経歴書の作成をサポートしています（公式サイト記載のサービス内容）。女性エンジニア向けの特別なサービスの記載はありませんが、リモートワークやフレックスタイム制などの働き方の条件は求人ごとに確認できます（対応求人の割合は公式サイトで要確認）。企業とのマッチング精度を重視したサポート方針で、長期的なキャリア形成を考える方にも適しています。",
    bestFor: [
      "独占求人で差別化したい方",
      "ゲーム業界に興味がある方",
      "書類選考に不安がある方",
  ...
  },
  {
    ...
    description:
      "リクルートエージェントは、非公開を含め約100万件（2026年6月時点）の求人を保有する最大手転職エージェントです。IT・エンジニア系の求人も数万件規模で保有しており、大手企業からスタートアップまで幅広い選択肢があります。転職支援実績もNo.1で、書類添削や面接対策のノウハウが蓄積されています。福利厚生が充実した大手企業の求人が多い点は、ライフイベントを考慮する女性エンジニアにとって大きなメリットです。",
    detailedReview:
  ...
  },
  {
    ...
    description:
      "Green（グリーン）は、IT業界に特化した転職プラットフォームです。約28,000件（2026年7月時点の公式サイト確認値）のIT求人を掲載しており、スタートアップやベンチャー企業の求人が特に豊富です。最大の特徴は「カジュアル面談」機能で、正式な選考前に企業と気軽に話すことができます。企業から直接スカウトが届く仕組みで、自分の市場価値を把握するのにも役立ちます（リモートワーク対応求人の割合は公式サイトで要確認）。",
    detailedReview:
      "Greenはエージェント型ではなくプラットフォーム型のサービスです。そのため、担当アドバイザーによるサポートはありませんが、自分のペースで自由に転職活動を進められます。最大の特徴である「カジュアル面談」機能は、正式な選考に進む前に企業の雰囲気や仕事内容を確認できるため、ミスマッチを防ぐのに非常に有効です。特にスタートアップやベンチャー企業の求人が豊富で、裁量の大きいポジションや最新技術を使ったプロジェクトに参画したい方に最適です。企業から直接スカウトが届く仕組みで、自分の市場価値を客観的に把握できます。社員の声や企業のカルチャー情報も掲載されており、企業選びの参考になります（リモートワーク対応求人の割合は公式サイトで要確認）。",
    bestFor: [
      "スタートアップで働きたい方",
      "カジュアルに転職活動を始めたい方",
      "自分のペースで活動したい方",
  ...
  },
  {
    ...
    name: "テックゴー（TechGo）",
    slug: "techgo",
    tagline: "年収交渉に強いIT特化の新鋭エージェント",
    type: "IT特化型",
    score: 4.0,
    jobs: "10,000件以上",
    feature: "平均年収UP138万円（2025年6〜7月実績）",
    maternityLeave: "公式サイトに記載なし（要確認）",
    remoteRate: "公式サイトに記載なし（要確認）",
    femaleAdvisor: "公式サイトに記載なし（要確認）",
    strengths: [
      "年収交渉の成功率100%を公式サイトで公表（2025年9月時点）しており、交渉を任せたい方に強い",
      "平均年収アップ138万円（2025年6〜7月実績）、20代平均+120万円・30代平均+160万円の実績を公表",
      "IT特化型で求人1万件以上、無料キャリア面談の登録は最短60秒",
    ],
    weaknesses: [
      "未経験者向けサポートについて公式サイトに記載がない",
      "女性向け専用プログラムの記載がなく、運営歴が浅いため第三者の口コミがまだ少ない",
    ],
    description:
      "テックゴー（TechGo）は、株式会社MyVision（有料職業紹介事業許可番号 13-ユ-314719）が運営するIT特化型の転職エージェントです。求人数は1万件以上。公式サイトで平均年収アップ138万円（2025年6〜7月実績）、年収交渉成功率100%（2025年9月時点）を公表しており、実務経験を活かして年収を上げたい方に向いています。無料キャリア面談は最短60秒で登録できます（数値はいずれも公式サイト・2026年7月確認）。",
    detailedReview:
      "テックゴーの最大の特徴は、年収交渉の実績を具体的な数値で公表している点です。平均年収アップ138万円（2025年6〜7月実績）、年代別では20代平均+120万円・30代平均+160万円、交渉成功率100%（2025年9月時点）と、公式サイトで実績を明示しています。運営は資本金1億円・従業員388名の株式会社MyVision。一方で、未経験者向けサポートや女性専用プログラムは公式サイトに記載がなく、サービスとしての歴史も浅いため第三者の口コミはまだ少なめです。当サイトでは、実務経験があり年収を上げたい方が、レバテックキャリアなどと併用する使い方をおすすめします。産休育休やリモートの条件は無料キャリア面談で直接確認しましょう。",
    bestFor: [
      "実務経験を活かして年収を大きく上げたい方",
      "年収交渉をプロに任せたい方",
      "IT特化のエージェントを併用先として追加したい方",
    ],
    recommendation:
      "経験者の年収アップ・交渉重視なら有力な選択肢。未経験サポートや女性向けプログラムを重視する方は他社が向いています。",
    recommendationScore: 3,
  },
];
...
const comparisonCriteria: { label: string; rows: CriterionRow[] } = {
  ...
  rows: [
    ...
    {
      name: "リモート求人比率",
      values: ["要確認", "要確認", "要確認", "要確認", "要確認", "要確認", "要確認", "100%特化", "要確認"],
    },
    {
      name: "女性アドバイザー",
      values: ["○", "◎", "○", "○", "○", "○", "−", "○", "−"],
...
const typeRecommendations = [
  ...
  {
    type: "年収交渉を任せたい方",
    agents: ["テックゴー（TechGo）", "レバテックキャリア"],
    reason:
      "年収アップ実績を公表しているIT特化型が有力。テックゴーは平均年収UP138万円（2025年6〜7月実績）・交渉成功率100%（2025年9月時点）を公式公表しています。",
  },
  {
    type: "幅広い選択肢から選びたい方",
...
const rankingFaqs = [
  ...
  },
  {
    ...
    answer:
      "ReWorks（リワークス）はフルリモート求人に特化しています。各社のリモート求人比率は公式に公表されていないため、面談時に希望条件として伝えて確認するのが確実です。レバテックキャリアやGreenなど各社でもリモート可の条件で求人を探せます。",
  },
  {
    ...
    <>
      ...
      <section className="section-primary-light py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-4xl font-bold leading-tight">
            女性エンジニアにおすすめの
            <br />
            <span className="text-gradient">転職エージェント・転職サイト9選</span>
            を徹底比較
          </h1>
          ...
          <p className="mt-6 text-sm text-text-light">
            最終更新: 2026年7月5日 | 比較対象: 9社 | 比較基準: 6項目
          </p>
        </div>
      </section>
          ...
          <div className="rounded-sm border border-border bg-[#fffaf4] p-5 md:p-7">
            ...
            <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                { q: "経験を活かして年収を大きく上げたい", a: "テックゴー（TechGo）", href: "/reviews/techgo/", d: "平均年収UP138万円（2025年6〜7月実績）" },
              ].map((c) => (
      ...
      <section className="section-light py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="mt-3 text-sm text-text-light">
            6つの基準で9社を横断比較。横スクロールで全社を確認できます。
          </p>
          <div className="mt-6 overflow-x-auto -mx-4 px-4">
            <table className="w-full min-w-[800px] bg-white border border-border rounded-lg text-sm">
              <thead>
