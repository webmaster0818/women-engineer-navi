...
export const metadata: Metadata = {
  ...
  keywords:
    "テックゴー 口コミ, テックゴー 評判, TechGo 評判, テックゴー 無料キャリア面談, テックゴー 面談 流れ, テックゴー 断られた, テックゴー 女性 エンジニア",
...
const faqData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "テックゴーはサービスの歴史が比較的浅いため、SNSや口コミサイトでの第三者の投稿がまだ少ない段階です。口コミが少ないこと自体は「怪しい」ことを意味しません。運営元の株式会社MyVisionは有料職業紹介事業許可（13-ユ-314719）を取得した実在の人材紹介会社で、コンサル転職エージェント「MyVision」の運営実績もあります。当サイトでは公式サイトの公開情報（実績数値・注記・会社概要）を確認した範囲で本ページを作成しており、掲載情報は2026年7月21日に公式サイトで再確認済みです。第三者の口コミを重視する方は、運営歴が長く情報が豊富なレバテックキャリアとの併用・比較をおすすめします。",
      },
    },
    {
      "@type": "Question",
      name: "テックゴーに登録を断られる・求人を紹介してもらえないことはありますか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "テックゴーはITエンジニアの転職支援に特化しているため、経験・スキル・希望条件によっては、紹介できる求人が限られる場合があります。公式サイトに「登録を断る」といった記載はありませんが、実務がまったくの未経験の方や、勤務地・年収などの条件を極端に絞っている場合は、マッチする求人が少なくなる可能性があります。もし紹介求人が少ない・合わないと感じたら、それはあなたに問題があるのではなく、そのエージェントの得意分野と希望がずれているだけのことが多いです。未経験からの育成に実績のあるワークポート、女性特化のtype女性の転職エージェントなど、タイプの異なるエージェントを2〜3社併用すると選択肢が広がります。まずは無料キャリア面談で、いまの経験でどんな求人があるのかを確認するところから始めましょう。",
      },
    },
  ],
};
      ...
      <section className="relative py-12 md:py-16" style={{ background: "linear-gradient(135deg, #efe3d8 0%, #f4e7da 100%)" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-4">
            ...
            <p className="mt-4 text-text-light">最終更新: 2026年7月21日（実績数値・サービス内容を公式サイトで同日再確認）</p>
          </div>
        </div>
      </section>
