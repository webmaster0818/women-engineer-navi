...
export const metadata: Metadata = {
  ...
  description:
    "レバテックキャリアを女性エンジニア目線で徹底レビュー。IT特化・求人約58,000件（2026年7月時点）・年収70万UP実績など、リアルな口コミと評判を紹介。産休育休やリモートワーク対応の求人情報も詳しく解説します。",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "レバテックキャリアを女性エンジニア目線で徹底レビュー。IT特化・求人約58,000件（2026年7月時点）・年収70万UP実績など、リアルな口コミと評判を紹介。",
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "はい、女性エンジニアにも使いやすいサービスです。求人情報が詳しく、働き方の希望を踏まえた提案を受けられます（女性アドバイザーの指名可否や、産休育休取得率などの事前共有の範囲は公式サイト・担当者に要確認）。IT業界に特化しているため、技術力を正当に評価した求人提案が受けられます。",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "レバテックキャリアはIT・Web業界に特化し、約58,000件（2026年7月時点の公式求人検索）のエンジニア求人を保有しています。リモートワーク対応求人も多数あります（割合は公式サイトで要確認）。非公開求人も多く含まれています。",
      },
    },
    {
      "@type": "Question",
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-4">
            ...
            <p className="mt-4 text-text-light">
              最終更新: 2026年7月17日（口コミセクションを公式サイト掲載の声に基づき再構成）
            </p>
          </div>
        </div>
      </section>
            ...
            <table className="w-full border-collapse rounded-lg overflow-hidden">
              <tbody>
                {[
                  ...
                  ["求人数", "約58,000件（2026年7月時点の公式求人検索・非公開含む）"],
                  ["対応エリア", "全国（東京・大阪・名古屋・福岡に拠点）"],
                  ["対応職種", "ITエンジニア・Webデザイナー・PM/PL・ITコンサルなど"],
                  ["利用料金", "無料"],
                  ["女性アドバイザー", "指名可否は公式サイト・担当者に要確認"],
                  ["リモート求人", "リモート対応求人多数（割合は公式サイトで要確認）"],
                  ["産休育休", "求人・企業情報の詳しさに定評（取得率の事前共有可否は担当者に要確認）"],
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              レバテックキャリアの最大の特徴は、IT・Web業界に完全特化している点です。エンジニア、デザイナー、PM/PLなどのIT職種に絞り込むことで、業界知識と求人の質の両面で高い専門性を実現しています。保有求人数は約58,000件（2026年7月時点の公式求人検索）と業界トップクラスで、大手企業からスタートアップまで幅広い企業の求人を取り揃えています。
            </p>
            <p>
              キャリアアドバイザーはIT業界出身者や技術に精通した人材が揃っており、エンジニアの技術スタックやキャリアパスを深く理解した上での提案が受けられます。年収70万円以上アップの実績も多数あり、適正な市場価値での転職を強力にサポートしてくれます。
            </p>
            <p>
              女性エンジニアの転職支援にも注力しています。求人・企業情報が詳しいことに定評があり、産休育休やリモートワークなど働き方の希望を踏まえた提案を受けられます（個別項目の事前共有可否は担当者に要確認）。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              ...
              {
                title: "リモートワーク求人が豊富",
                desc: "リモートワーク対応求人が多数（割合は公式サイトで要確認）。フレックスタイム制やフルリモートなど、柔軟な働き方ができる求人が豊富で、ワークライフバランスを重視する女性に適しています。",
              },
              {
                title: "技術力を正当に評価する提案",
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <p className="text-xs text-text-light mb-8">
            ※以下はレバテックキャリア公式サイト「レバテックキャリアの評判・口コミ」ページに掲載されている内容を要約・再構成したものです。出典元の原文とは異なります。公式サイトでの発信である点に留意してください。サービス内容は調査時点（2026年7月）のものであり、変更される場合があります。
          </p>
          ...
          <p className="text-sm text-text-light mb-4 leading-relaxed">
            公式サイトの評判・口コミページには、2,500人以上の利用者から寄せられた声が「良い点」「気になる点」の両方で掲載されています。同ページのアンケート結果では「アドバイザーは誠実」に97%が当てはまると回答（3,800人の回答）、「友人におすすめしたいか」は4.0（4,216人の回答）と公表されています。
          </p>
          <div className="space-y-4 mb-8">
            {[
              {
                reviewer: "30代・男性・アプリケーションエンジニア（2018年7月投稿・良い点）",
                text: "他社サービスと比較して、アドバイザーのヒアリング能力や知識量、段取りや姿勢の面で優れていると感じた。最初のヒアリングから企業への申し込みを無理強いしてこないところも好印象だった。",
              },
              {
                reviewer: "20代・女性・アプリケーションエンジニア（2020年4月投稿・良い点）",
                text: "何も知らない自分に親身になって答えてくれた。大手のエージェントに比べて、ピンポイントで応募しやすいのが良い。",
              },
              {
                reviewer: "20代・女性・エンジニア（2020年4月投稿・紹介された転職先について）",
                text: "前職に比べて残業が少なく、休みもきちんと取れるようになった。",
              },
              {
                reviewer: "40代・男性・クリエイター（2019年10月投稿・気になる点）",
                text: "得意とされている領域がかなり絞られており、万人向けのキャリアサービスではないと感じた。志望キャリアがフィットする人にとっては、とても良いサービスだと思う。",
              },
            ].map((review, i) => (
              <div
                key={i}
          ...
          <div className="space-y-4 mb-6">
            {[
              {
                reviewer: "実務未経験向けの求人は中心ではない",
                text: "レバテックキャリアはIT・Web業界の経験者向けサービスのため、完全未経験の方に紹介できる求人は限られます。未経験からのエンジニア転職を目指す方は、未経験支援に実績のあるエージェント（ワークポートなど）との併用が現実的です。",
              },
              {
                reviewer: "対面の面談拠点は都市部の4カ所",
                text: "公式サイトのサービス紹介ページによると、対面の面談場所は渋谷（東京本社）・名古屋・大阪・福岡の4拠点です（2026年7月確認）。近くに拠点がない地域の方も電話・Webでの面談が可能と公式FAQに記載されていますが、地方求人は都市部と比べて少ない傾向がある点は理解しておきましょう。",
              },
              {
                reviewer: "公式掲載の口コミは投稿時期がやや古いものが中心",
                text: "公式サイトの評判・口コミページに掲載されている個別の投稿は、投稿日が2018〜2020年のものが中心です。掲載内容は公式サイトでの発信である点も踏まえ、最新のサポート体制や担当者との相性は、無料面談やみん評などの第三者口コミサイトで確かめるのが確実です。",
              },
            ].map((review, i) => (
              <div
                key={i}
          ...
          <div className="text-xs text-text-light mt-4 space-y-1">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                ...
                >
                  レバテックキャリア公式サイト - レバテックキャリアの評判・口コミ
                </a>
                （2026年7月参照）
              </li>
              <li>
                <a
                  href="https://career.levtech.jp/service/"
                  target="_blank"
                  rel="noopener noreferrer nofollow"
                  className="underline hover:text-primary"
                >
                  レバテックキャリア公式サイト - 転職エージェントサービス紹介（面談場所・アクセス）
                </a>
                （2026年7月参照）
              </li>
              <li>
                <a
                  href="https://minhyo.jp/levtech"
                  target="_blank"
                  rel="noopener noreferrer nofollow"
                  className="underline hover:text-primary"
                >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <ul className="space-y-3">
                {[
                  "IT業界に特化した約58,000件（2026年7月時点）の質の高い求人を保有しており、エンジニアにとって最も専門性の高いエージェントの一つ",
