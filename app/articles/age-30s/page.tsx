    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          >
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 30代女性エンジニアの転職市場【実データ】</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 30代女性エンジニアの年収相場（経験者・未経験別）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 30代前半と30代後半で変わる転職戦略</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 経験者のキャリアアップ転職（3つの方向性）</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 30代未経験からのIT転職の現実と攻略法</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. ライフイベントとの両立戦略</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. 30代の転職活動の進め方</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-3 mt-6">
            <div className="rounded-xl border p-6 text-center" style={{ borderColor: "#d1dce5" }}>
              <p className="text-3xl font-bold" style={{ color: "#0891b2" }}>13.2%</p>
      ...
      <section id="sec2" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>30代全体（全職種）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>454万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>男性510万円・女性393万円</td>
                </tr>
                ...
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>30代・エンジニア経験者</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>500万円台が現実的レンジ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>クラウド・AI・リーダー経験で600万〜700万円台も</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>30代・未経験からの転職1年目</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>300万〜400万円程度</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>一時的に下がるが、数年で前職水準を超える設計が一般的</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>30代で年収を上げる3つのレバー</h3>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>30代前半（30〜34歳）：実務経験×ポテンシャルの最終ゾーン</h3>
              <ul className="space-y-2 text-sm text-text-light">
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>30代後半（35〜39歳）：「再現性のある実績」で勝負</h3>
              <ul className="space-y-2 text-sm text-text-light">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              前後の年代の戦略も知っておくと、いま打つべき手が明確になります。<a href="/articles/age-20s/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>20代女性エンジニアの転職ガイド</a>では基礎づくり、<a href="/articles/age-40s/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>40代女性エンジニアの転職ガイド</a>では専門性の換金フェーズを解説しています。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>① マネジメント方向：リーダー・EM・PMへ</h3>
              <p className="text-sm text-text-light leading-relaxed">
                30代はマネジメント転身の最適期です。日本の課長級に占める女性割合はまだ1〜2割台で、女性管理職の登用目標を掲げる企業ではリーダー経験のある女性エンジニアの争奪戦が起きています。チームリード・後輩育成・進捗管理の経験は小さくても書き出し、PMP・スクラムマスター等の資格で補強を。詳しくは<a href="/articles/women-manager/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアの管理職キャリアガイド</a>で解説しています。
              </p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>② スペシャリスト方向：クラウド・AI・セキュリティで単価を上げる</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>③ 働き方方向：年収維持×フルリモート・フレックスへ</h3>
              <p className="text-sm text-text-light leading-relaxed">
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>30代未経験の攻略法5箇条</h3>
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              学習ロードマップや職種の選び方は<a href="/articles/beginner/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>未経験からエンジニアになるガイド</a>で詳しく解説しています。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>転職タイミングの考え方</h3>
              <ul className="space-y-2 text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>企業選びの確認ポイント</h3>
              <ul className="space-y-2 text-sm text-text-light">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              出産後のキャリア設計・時短復帰のリアルは<a href="/articles/mama-engineer/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>ママエンジニアの働き方ガイド</a>で詳しく解説しています。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec9" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Aさん（30代前半・経験者のキャリアアップ）</h3>
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Bさん（30代後半・両立軸の転職）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}>
                  <p className="text-xs font-bold text-text-light mb-1">転職前</p>
      ...
      <section className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/age-20s/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>20代女性エンジニアの転職ガイド</h3>
              <p className="text-sm text-text-light">基礎づくりとポテンシャル転職の戦略</p>
            </a>
            <a href="/articles/age-40s/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>40代女性エンジニアの転職ガイド</h3>
