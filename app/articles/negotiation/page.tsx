    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. データで見る年収交渉の実態（実施率・成功率）</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 女性エンジニアこそ交渉すべき理由</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 年収交渉のタイミング比較表</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 伝え方のフレーズ例（場面別）</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 市場相場の調べ方（job tag・doda）</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. エージェント経由の交渉の仕組み</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. 交渉で避けるべきNG行動</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#0891b2" }}>8. 年収以外に交渉・確認できる条件</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>年収交渉の主要データまとめ（2026年6月参照）</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>転職時に年収交渉をした人: <strong>55.9%</strong>／うち年収アップ成功: <strong>85.2%</strong>（マイナビ転職調査）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>ITエンジニアの交渉経験率: <strong>74.5%</strong>／うち年収アップ実現: <strong>90.8%</strong>（キッカケクリエイション調査）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>交渉しなかった理由1位: <strong>「印象が悪くなる不安」30.9%</strong>（同調査）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>転職で賃金が増加した人: <strong>40.5%</strong>（1割以上の増加は29.4%。令和6年雇用動向調査）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>交渉したITエンジニアの転職エージェント活用率: <strong>83.7%</strong>（キッカケクリエイション調査）</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="sec2" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              なお、女性エンジニアの年収水準そのもの（女性ITエンジニア平均419万円・女性SE約497万円など）と男女差の全体像は <a href="/articles/salary/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアの年収ガイド</a> で詳しく解説しています。20代の男女差はほぼゼロで、差が開くのは30代以降。交渉はこの差を埋めるための、最も即効性のある手段です。
            </p>
          </div>
        </div>
      </section>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>注意点</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>応募時（書類）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>希望年収欄に相場ベースの希望額を記載</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>求人の提示レンジから大きく外れた額は書類段階で不利になりうる</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>面接中</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>聞かれたら現年収と希望額＋根拠を簡潔に答える</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>自分から金額の引き上げを切り出すのは避ける。評価が固まる前の交渉は分が悪い</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5", color: "#7c3aed" }}>内定後・オファー面談</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5", color: "#7c3aed" }}>交渉の本番。提示条件を確認し、根拠を添えて希望を伝える</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>企業は「入社してほしい」状態。回答期限の延長依頼も可能</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>エージェント経由（全期間）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>希望額と根拠を担当者に伝え、代行交渉してもらう</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>気まずさゼロで交渉できる。任せきりにせず根拠は自分で用意する</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>入社承諾後</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>原則交渉不可</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>労働条件通知書にサインした後の変更は基本的にできない。承諾前に条件を固める</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-text-light leading-relaxed mt-4 text-sm">
            ※オファー面談で年収以外に確認すべき項目（昇給制度・評価サイクル・残業代の扱いなど）は <a href="/articles/offer-meeting/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>オファー面談で確認すべきこと完全ガイド</a> にチェックリストをまとめています。
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>面接で希望年収を聞かれたとき</h3>
              <p className="text-sm text-text-light leading-relaxed">
                「現在の年収は◯◯万円です。job tagや転職サービスの公開データを見ると、同職種・同程度の経験では◯◯万円前後が相場のようですので、◯◯万円を希望しています。最終的には業務内容と評価制度を踏まえてご相談できればと思います」
              </p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>オファー面談で提示額を上げてほしいとき</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>他社のオファーと比較しているとき</h3>
              <p className="text-sm text-text-light leading-relaxed">
                「他社から◯◯万円のご提示をいただいていますが、事業内容と開発体制の面で御社を第一に考えています。条件面で再度ご検討いただける余地はありますでしょうか」※実在しないオファーを持ち出すのは信頼を失うため厳禁です。
              </p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>エージェントに交渉を依頼するとき</h3>
              <p className="text-sm text-text-light leading-relaxed">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>情報源</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>わかること</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>使い方のポイント</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>job tag（厚生労働省・職業情報提供サイト）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>職業別の平均年収（賃金構造基本統計調査ベース）・求人賃金・有効求人倍率・年齢別賃金カーブ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>公的データなので交渉の根拠として最も使いやすい。職種名で検索し全国・都道府県別に確認</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>doda「平均年収ランキング」</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>職種別・年代別・男女別の平均年収（登録者約60万人のデータ）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>転職市場の実勢に近い。技術系（IT/通信）21職種の細分データが見られる</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>レバテック等の職種別集計</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>賃金構造基本統計調査をもとにした職種・年齢・男女別の年収集計</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>女性SE約497万円など男女別の水準確認に有用</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>同職種の求人票の提示レンジ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>自分と同じスキルセット・経験年数の「今の」募集条件</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>5〜10件集めてレンジの中央値を把握。スカウトの提示額も参考になる</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            ...
            <p>
              dodaの「平均年収ランキング2025」では技術系（IT/通信）全体の平均は469万円、職種別ではプロジェクトマネジャー707万円など職種で大きく差があります。<strong>自分の職種の相場を知らずに「現年収＋50万円」のような決め方をすると、相場より低く着地するリスク</strong>があります。職種ごとの詳しい相場は <a href="/articles/salary-by-job/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアの職種別年収比較</a> を参考にしてください。出典: doda「平均年収ランキング2025」（パーソルキャリア、2026年6月参照）
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              ただし注意点もあります。エージェントには「早く入社を決めたい」というインセンティブも同時に働くため、任せきりにすると提示額のまま話が進むことがあります。<strong>希望額と根拠（相場データ・実績）を自分の言葉で明確に伝え、「市場相場ベースで交渉してほしい」と依頼する</strong>ことが重要です。エージェントと転職サイトの使い分け・併用方法は <a href="/articles/agent-vs-site/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>転職エージェントと転職サイトの違い</a> で詳しく解説しています。
            </p>
            <div className="grid gap-6 md:grid-cols-2 mt-6">
              <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
                <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>エージェント交渉のメリット</h3>
              ...
              <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
                <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>任せきりにしない</h3>
      ...
      <section id="sec7" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-base font-bold mb-2" style={{ color: "#7c3aed" }}>1. 根拠のない金額を要求する</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-base font-bold mb-2" style={{ color: "#7c3aed" }}>2. 現年収や他社オファーを偽る</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-base font-bold mb-2" style={{ color: "#7c3aed" }}>3. 金額の話を何度も蒸し返す</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-base font-bold mb-2" style={{ color: "#7c3aed" }}>4. 内定承諾後・入社後に交渉する</h3>
              <p className="text-sm text-text-light leading-relaxed">労働条件通知書に合意した後の変更は基本的にできません。条件は承諾前にすべて確定させ、不明点はオファー面談で確認し切ることが大切です。</p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-base font-bold mb-2" style={{ color: "#7c3aed" }}>5. 感情や生活事情だけを理由にする</h3>
      ...
      <section id="sec8" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 入社後の昇給制度・評価サイクルを確認する</h3>
              <p className="text-sm text-text-light leading-relaxed">
                初年度の提示額が希望に届かなくても、昇給が年2回・等級制度が明確な会社なら1〜2年で逆転できます。オファー面談で「評価・昇給のサイクル」「等級ごとの年収レンジ」「直近の昇給実績」を確認し、可能なら「1年後に◯◯を達成した場合の想定年収」を聞いておきましょう。確認項目の全リストは <a href="/articles/offer-meeting/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>オファー面談で確認すべきこと完全ガイド</a> にまとめています。
              </p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. ストックオプション（SO）・賞与・手当</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. リモート・フレックス・時短などの働き方条件</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. 入社日・入社一時金・引っ越し費用</h3>
              <p className="text-sm text-text-light leading-relaxed">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a href="/articles/offer-meeting/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>オファー面談で確認すべきこと完全ガイド</h3>
