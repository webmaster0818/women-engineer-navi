    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 在職中に転職活動するメリット</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 在職中転職の全体スケジュール（3〜6ヶ月）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 平日面接の日程調整術</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 会社にバレないための注意点</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 仕事と両立する効率化のコツ（6STEP）</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. 内定後〜退職交渉のタイミング</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. おすすめ転職エージェント</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#0891b2" }}>8. 在職中転職の成功事例</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 収入が途切れず生活が安定する</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 焦らず条件で妥協しない</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. ブランクなしで職務経歴を保てる</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. 「現職に残る」も選択肢に残せる</h3>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>在職中にやること</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>① 準備・書類作成</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約2週間</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>自己分析・希望条件の整理、職務経歴書とポートフォリオの更新、エージェント登録・面談</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>② 応募・書類選考</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約2〜3週間</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>5〜10社へ並行応募、スカウト対応、コーディングテスト（GitHub課題やHackerRank形式）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>③ 面接</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約1ヶ月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>一次〜最終（多くは2〜3回）。技術面接・カジュアル面談含む。平日夜・オンラインで調整</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>④ 内定・条件確認</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約1〜2週間</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>労働条件通知書で年収・リモート・時短の可否を確認、年収交渉、入社日合意</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>⑤ 退職交渉・引き継ぎ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約1〜1.5ヶ月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>上司へ退職申し出、引き継ぎ資料作成、有給消化、入社</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>逆算のコツ</h3>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. オンライン面接を依頼する</h3>
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 始業前・終業後・昼休みに設定</h3>
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. 有給より半休（午前・午後休）</h3>
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. 1日に2〜3社まとめて受ける</h3>
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>日程変更を依頼するメール例</h3>
      ...
      <section id="sec4" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>休みの取り方を不規則に</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>会社の設備で活動しない</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>スカウトは現職を非公開に</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>身だしなみと言動に注意</h3>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#7c3aed" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>女性が押さえておきたいポイント</h3>
            <p className="text-text-light text-sm leading-relaxed">
      ...
      <section id="sec8" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Cさん（30代前半・SES→自社開発・育児と両立）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">活動前</p><p className="text-sm font-bold">SESのJavaエンジニア / 出社必須・残業多め / 年収450万円</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>活動後</p><p className="text-sm font-bold">自社開発企業 / フルリモート・時短可 / 年収520万円</p></div>
              </div>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Dさん（20代後半・受託→SaaS・バレずに完走）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">活動前</p><p className="text-sm font-bold">受託開発のフロントエンド / 年収400万円</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>活動後</p><p className="text-sm font-bold">SaaS企業のフロントエンド / フレックス / 年収500万円</p></div>
              </div>
      ...
      <section className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/schedule/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>転職活動のスケジュールガイド</h3><p className="text-sm text-text-light">いつから始める？期間と流れ</p></a>
            <a href="/articles/interview-guide/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>面接対策ガイド</h3><p className="text-sm text-text-light">よく聞かれる質問と答え方</p></a>
            <a href="/articles/resume-guide/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>職務経歴書の書き方ガイド</h3><p className="text-sm text-text-light">通過率を上げる書き方</p></a>
            <a href="/articles/negotiation/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>年収交渉ガイド</h3><p className="text-sm text-text-light">内定後の条件交渉のコツ</p></a>
          </div>
        </div>
      </section>
