    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 東京のIT転職市場の特徴</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 求人動向と特徴（業態の幅広さ）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 東京のエンジニア年収相場（地域比較表）</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 女性が働きやすい東京の企業</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 未経験から東京で転職するには</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. リモートという選択肢（保活・通勤事情）</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>東京で転職する3つのメリット</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>求人数が全国最多。条件で絞り込んでも選択肢が豊富</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>年収相場が全国トップ（東京567万円前後 / 全国平均537万円）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>勉強会・コミュニティ・スクールが集積し学習環境が整う</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>自社開発・メガベンチャー</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>スタートアップ・SaaS</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>大手SIer・社内SE</h3>
              <p className="text-text-light text-sm leading-relaxed">福利厚生・休暇制度が手厚く、安定志向の女性に人気。社内SEは自社業務を支える役割で、残業が読みやすくライフイベントと両立しやすい傾向。</p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>ITコンサル・受託開発</h3>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>地域</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>ITエンジニア平均年収の目安</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>備考</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>東京都</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約562万〜580万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>全国トップ。SE単体では約579万円との調査も</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>関東（東京除く）</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約500万〜520万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>神奈川・千葉・埼玉。東京通勤圏で高め</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>大阪府</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約520万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>関西の中心。東京に次ぐ求人規模</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>地方都市</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約450万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>東京との差は最大130万〜200万円</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>全国平均</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約537万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>2024年9月〜2025年8月調査</td></tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>東京で年収を最大化する3つの視点</h3>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>リモートを軸に東京求人を選ぶときのチェック点</h3>
              <ul className="space-y-2 text-sm text-text-light">
      ...
      <section id="sec8" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Cさん（30代前半・地方SIer→東京の自社開発）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">転職前</p><p className="text-sm font-bold">地方SIerのSE / 年収420万円・常駐勤務</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>転職後</p><p className="text-sm font-bold">東京の自社開発SaaS / 年収580万円・フルリモート（地方在住のまま）</p></div>
              </div>
              <p className="text-sm text-text-light">IT特化型エージェント経由で、地方在住可のフルリモート求人に応募。引っ越さず東京水準の年収を得て、保活の負担が軽い地元で子育てしながら働く環境を実現しました。</p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Dさん（20代後半・未経験→東京のメガベンチャー）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">転職前</p><p className="text-sm font-bold">都内の事務職（IT未経験）/ 年収340万円</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>転職後</p><p className="text-sm font-bold">東京のメガベンチャー（バックエンド）/ 年収480万円・フレックス</p></div>
              </div>
      ...
      <section className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a href="/articles/remote-jobs/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>リモート求人の探し方</h3><p className="text-sm text-text-light">フルリモートで働くための条件</p></a>
            <a href="/articles/women-friendly-companies/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性が働きやすい企業の見つけ方</h3><p className="text-sm text-text-light">くるみん・えるぼしで見極める</p></a>
            <a href="/articles/how-to-choose/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>転職エージェントの選び方</h3><p className="text-sm text-text-light">失敗しないエージェント選び</p></a>
          </div>
        </div>
      </section>
