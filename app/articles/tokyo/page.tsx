      ...
      <section id="sec1" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              さらに東京都は、女性のIT人材育成に行政としても力を入れています。東京都が運営する<a href="/articles/tokyo-women-training/" className="underline font-semibold" style={{ color: "#7c3a55" }}>「女性ITエンジニア育成事業」（受講料無料・詳細解説はこちら）</a>のように、未経験から学び直してエンジニアを目指す女性向けの公的な支援も存在し、学習・キャリア形成の土台が整っているのも特徴です。
            </p>
