    ...
    <>
      ...
      <section className="py-8">
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl p-6" style={{ backgroundColor: "#ecfeff", border: "2px solid #0891b2" }}>
            <h2 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>結論：最新データの即答</h2>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>年度</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>女性の育休取得率</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>男性の育休取得率</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2019年度（令和元）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>83.0%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>7.48%</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2020年度（令和2）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>81.6%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>12.65%</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2021年度（令和3）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>85.1%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>13.97%</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2022年度（令和4）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>80.2%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>17.13%</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2023年度（令和5）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>84.1%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>30.1%</td>
                </tr>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2024年度（令和6・最新）</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>86.6%</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>40.5%（過去最高）</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>産業</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>女性</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>男性</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>情報通信業（IT業界）</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>94.4%</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>58.1%</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>全産業（総数）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>86.6%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>40.5%</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>金融業・保険業</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>98.8%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>63.6%</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>学術研究・専門・技術サービス業</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>93.8%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>60.7%</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>製造業</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>94.4%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>48.7%</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>医療・福祉</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>90.9%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>49.7%</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>卸売業・小売業</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>83.1%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>29.9%</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>宿泊業・飲食サービス業</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>57.3%</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>33.3%</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            ...
            <p>
              IT業界の数値が高い背景としては、テレワーク導入率が<strong>94.3%と全産業トップ</strong>（全産業平均47.3%、出典: 総務省「令和6年通信利用動向調査」）であること、人材獲得競争の中で両立支援を採用広報に使う企業が多いことが挙げられます。育児と両立しやすい働き方の実態は<a href="/articles/mama-engineer/" className="underline" style={{ color: "#0891b2" }}>ママエンジニアの働き方ガイド</a>で詳しく解説しています。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec3" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                ...
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>企業が自主公開する復帰率・復職率</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>大手IT企業の公開値は概ね97〜100%（次章の実例参照）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>各社の公式サステナビリティ／ESGデータページ</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            ...
            <p>
              実務的な結論はこうです。<strong>業界平均の復帰率は存在しないので、応募する企業ごとの公開値・実績を個別に確認する</strong>のが唯一の正攻法です。確認手段は4章（企業公開値）と6章（公的データベース）で具体的に解説します。復帰後のキャリアの組み立て方は<a href="/articles/after-maternity/" className="underline" style={{ color: "#0891b2" }}>産休・育休後のキャリアの記事</a>を参照してください。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>企業</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>公開している実績</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>出典（公式）</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>DeNA</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>育休取得率 女性100%・男性64.5%、育児休業復職率98.3%（いずれも2025年3月期）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>DeNA サステナビリティサイト「ESGデータ」</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>サイバーエージェント</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>産休・育休後の復帰率97.2%（単体）。女性活躍支援制度「macalonパッケージ」を運用</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>公式「データで見るサイバーエージェント」</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>NTTデータ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>男性社員の育休取得率99.8%・平均取得日数100.3日（2024年度）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>NTTデータグループ公式トピックス（2025年9月）</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>富士通</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>育児休職後の復職率100%（男女とも、2021年度）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>富士通グループ サステナビリティデータブック2022</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>給付</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>支給率・内容</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>主な要件</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>育児休業給付金</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>休業開始時賃金の<strong>67%</strong>（開始〜180日）→ <strong>50%</strong>（181日目以降）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>雇用保険被保険者で、原則1歳未満（保育所に入れない場合等は最長2歳まで延長）の子の育休</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>出生後休業支援給付金<br />（2025年4月創設）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>最大28日間、<strong>13%を上乗せし合計80%</strong>。社会保険料免除・非課税のため<strong>手取り約10割相当</strong></td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>子の出生直後の一定期間に<strong>夫婦ともに14日以上</strong>の育休取得（配偶者が専業主婦（夫）の場合等は単独取得でも対象）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>育児時短就業給付金<br />（2025年4月創設）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>時短勤務中の賃金の<strong>原則10%</strong>を支給</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>2歳未満の子を育てて時短勤務する雇用保険被保険者</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              ポイントは、育休中は<strong>社会保険料（健康保険・厚生年金）が免除され、給付金が非課税</strong>であるため、額面の支給率以上に手取りベースの実質保障が厚いことです。67%支給の期間でも手取り比では約8割に相当するとされます。なお産前産後休業（産前6週・産後8週）中は、健康保険から出産手当金（標準報酬日額の3分の2）が支給されます。復帰後の時短勤務と収入の関係は<a href="/articles/short-time/" className="underline" style={{ color: "#0891b2" }}>時短勤務エンジニアの記事</a>で詳しく解説しています。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 女性の活躍推進企業データベース（厚生労働省）</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>2. 両立支援のひろば（厚生労働省）</h3>
              <p className="text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. 各社のサステナビリティ／ESGデータページ</h3>
              <p className="text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>4. 転職エージェント経由で運用実態を確認する</h3>
              <p className="text-sm text-text-light">
      ...
      <section id="sec7" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 「取得率100%超」がありうる</h3>
              <p className="text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>2. 「取得率」と「取得期間」はセットで見る</h3>
              <p className="text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. 産業別の数値は年度間の振れが大きい</h3>
              <p className="text-sm text-text-light">
