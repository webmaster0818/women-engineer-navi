    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          >
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. エンジニア副業の現在地【実データ】</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 副業の形態比較表（単価目安つき）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 始め方4ステップ（就業規則確認→小さく開始→確定申告）</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 副業の税金：「20万円ルール」の正確な中身</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 就業規則・競業避止・情報管理の注意点</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. 本業との両立とバーンアウト対策</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. 副業実績を転職市場で活かす方法</a></li>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-3 py-3 text-left" style={{ borderColor: "#d1dce5" }}>形態</th>
                  <th className="border px-3 py-3 text-left" style={{ borderColor: "#d1dce5" }}>単価の目安</th>
                  <th className="border px-3 py-3 text-left" style={{ borderColor: "#d1dce5" }}>向いている人・特徴</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>週末・平日夜の開発案件（業務委託）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>時給2,000〜6,000円程度（エージェント案件水準=ITプロマガジン）。クラウドソーシングは1,000〜3,000円程度と低め</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>実務2〜3年以上。本業に近いスキルで最も稼ぎやすい王道。週10時間×時給3,000円で月約12万円の計算</td>
                </tr>
                <tr>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>技術記事の執筆・教材作成</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>1記事5,000円〜3万円程度（公開求人水準の目安）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>納期が緩く、育児中などまとまった時間が取れない人向き。発信実績がそのまま転職時のアピールになる</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>メンター・プログラミング講師</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>時給1,500〜3,000円程度（スクールのメンター公開募集水準の目安）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>時間が読めて両立しやすい。単価は控えめだが、教えることで知識が体系化され本業にも還元される</td>
                </tr>
                <tr>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>コードレビュー・技術顧問・スポット相談</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>時給4,000円〜1万円程度（公開求人水準の目安）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>実務5年以上の経験を「時間売り」せず高単価で売れる形態。稼働が短くburnoutしにくいのが利点</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Webサイト制作（請負）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>1件5万〜15万円程度（公開求人水準の目安）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>納品物が明確で実績を作りやすい反面、修正対応の範囲を契約で決めないと時給換算が大きく下がりやすい</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section id="sec3" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              副業はフリーランス独立の「試運転」としても最良の手段です。会社員の信用と社会保険を保ったまま、自分のスキルが社外でいくらで売れるかを検証できます。独立まで視野に入れている場合は<a href="/articles/freelance/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性フリーランスエンジニアの始め方</a>で、単価相場と保障の違いを先に確認しておきましょう。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>所得税：副業「所得」が年20万円超なら確定申告が必要</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl p-6" style={{ backgroundColor: "#fff7ed", border: "2px solid #f97066" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#f97066" }}>住民税：20万円以下でも申告が必要（最重要の注意点）</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>住民税の納付方法と「会社に知られる」経路</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>継続するなら：開業届と青色申告</h3>
              <p className="text-sm text-text-light leading-relaxed">
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>会社が制限できる4類型（モデル就業規則第70条）</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>エンジニアが実務で守るべきライン</h3>
              <ul className="space-y-2 text-sm text-text-light">
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>先に決めておくルール</h3>
              <ul className="space-y-2 text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#f97066" }}>撤退・縮小のサイン</h3>
              <ul className="space-y-2 text-sm text-text-light">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              通勤時間をなくして副業の時間を捻出する、という順番の工夫も有効です。本業を<a href="/articles/remote-jobs/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>リモートワーク可の職場</a>に移すだけで、平日に往復1〜2時間の可処分時間が生まれます。「副業のために睡眠を削る」のではなく「副業できる生活構造に変える」発想が長続きの鍵です。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec7" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>職務経歴書・面接での見せ方</h3>
              <ul className="space-y-2 text-sm text-text-light">
                ...
                <li>・<strong>数字で語る</strong>：「月X時間の稼働で、リリースをN回」「レビュー対応をX件」など。守秘義務に反しない範囲で成果物のスクリーンショットやリポジトリを<a href="/articles/portfolio/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>ポートフォリオ</a>に組み込む</li>
                <li>・<strong>年収交渉の材料にする</strong>：「副業で時給換算X円の値がついている」という事実は、自分の市場価値の客観的な根拠になる。相場感は<a href="/articles/salary/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアの年収ガイド</a>で確認を</li>
              </ul>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>女性エンジニアにとっての戦略的な意味</h3>
              <p className="text-sm text-text-light leading-relaxed">
                出産・育児などで本業のキャリアに中断期間が生じやすい人ほど、副業の「社外実績」は効きます。会社の評価制度の外に、自分の名前で積み上がる実績と取引先を持っておくことは、復職・転職・将来の独立のすべてで選択肢を増やします。時短勤務中でも続けられる小さな技術執筆やメンタリングは、ブランクを「空白」にしない手段にもなります。会社員の保障を持ったまま試せるのが副業の最大の利点です。独立まで進む場合の単価相場・保障の違いは<a href="/articles/freelance/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>フリーランスガイド</a>で解説しています。
              </p>
            </div>
          </div>
          <p className="text-text-light text-sm mt-3">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/freelance/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性フリーランスエンジニアの始め方</h3>
            ...
            <a href="/articles/portfolio/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>ポートフォリオの作り方</h3>
