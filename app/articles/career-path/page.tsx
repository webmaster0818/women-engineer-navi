    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          >
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 女性エンジニアのキャリアを取り巻く現状【実データ】</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. キャリアパス5類型の比較表（年収・働き方・向き不向き）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 5つのキャリアパス徹底解説</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. ライフイベントを織り込んだキャリア設計（時短期・復帰期）</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 年代別ロードマップ：いつ・何を決めるか</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. 自分に合うキャリアパスの選び方3ステップ</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. おすすめ転職エージェント</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#0891b2" }}>8. キャリアチェンジのモデルケース</a></li>
      ...
      <section id="sec2" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-3 py-3 text-left" style={{ borderColor: "#d1dce5" }}>キャリアパス</th>
                  <th className="border px-3 py-3 text-left" style={{ borderColor: "#d1dce5" }}>年収目安（出典）</th>
                  <th className="border px-3 py-3 text-left" style={{ borderColor: "#d1dce5" }}>働き方の特徴</th>
                  <th className="border px-3 py-3 text-left" style={{ borderColor: "#d1dce5" }}>向いている人</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>① スペシャリスト<br /><span className="font-normal text-xs">技術を究める</span></td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>エンジニア平均469万円（doda 2025）。クラウド・AI・セキュリティ等の高需要領域は600万〜800万円台の求人も（求人水準の目安）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>技術力＝市場価値。リモート・時短と最も相性が良い</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>技術探求が好き。深い集中時間を確保したい人</td>
                </tr>
                <tr>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>② マネジメント<br /><span className="font-normal text-xs">EM・管理職</span></td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>600万〜800万円台が目安（EM・開発マネージャー求人の水準）。課長相当職の女性は12.3%で希少（厚労省）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>会議・調整が増えるが裁量も大。登用目標を掲げる企業で需要大</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>人の成長に喜びを感じる。チームで成果を出したい人</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>③ PM・PdM<br /><span className="font-normal text-xs">プロジェクト/プロダクト推進</span></td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>プロジェクトマネジャー707万円=IT技術職1位（doda 2025）、PdM約774万円（PM Career調査）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>関係者調整が中心。年収レンジが最も高い路線のひとつ</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>段取り・調整が得意。ビジネス側にも興味がある人</td>
                </tr>
                <tr>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>④ 社内SE・コーポレートIT<br /><span className="font-normal text-xs">事業会社のIT部門</span></td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>約510万〜580万円（求人ボックス約510万円、Geekly独自データ約580万円）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>納期プレッシャーが比較的小さく残業少なめ。両立人気が高い</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>安定と両立を重視。業務改善・調整が得意な人</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-3 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>⑤ フリーランス<br /><span className="font-normal text-xs">独立・業務委託</span></td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>SE案件の平均単価 月72万円（年商換算864万円）、PM案件88万円、ITコンサル案件102万円（レバテックフリーランス公開案件）</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>時間・場所・案件を自分で選べる。収入と保障は不安定</td>
                  <td className="border px-3 py-3" style={{ borderColor: "#d1dce5" }}>実務3年以上で自走できる。自由度を最優先したい人</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              重要なのは、<strong>5類型は排他的な一方通行ではない</strong>ということです。スペシャリストからPMへ、社内SEからマネジメントへ、会社員からフリーランスを経て再び会社員へ——技術の土台さえあれば行き来できます。職種別の詳しい年収比較は<a href="/articles/salary-by-age/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>年代別年収ガイド</a>もあわせてご覧ください。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec3" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>③ PM・PdM：年収レンジが最も高い「推進役」</h3>
              <p className="text-sm text-text-light leading-relaxed">
                プロジェクトマネジャー（PM）はdoda「平均年収ランキング2025」で<strong>707万円とIT/通信系技術職の1位</strong>。プロダクトマネージャー（PdM）はさらに高く<strong>約774万円</strong>（PM Career調査）で、エンジニア平均469万円から200万〜300万円の上積みが狙える路線です。コードを書く時間は減りますが、要件定義・優先順位付け・関係者調整といった「翻訳能力」が価値になるため、エンジニア出身者は強い武器を持ってスタートできます。PMO・PM補佐から小さく始められるのも特徴です。仕事内容・必要スキル・転職ルートは<a href="/articles/pm-director/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>PM・Webディレクターへのキャリアチェンジガイド</a>で解説しています。
              </p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>④ 社内SE・コーポレートIT：両立と安定を最優先するなら</h3>
              <p className="text-sm text-text-light leading-relaxed">
                事業会社のIT部門で、システム企画・ベンダー管理・業務改善・DX推進を担う路線です。平均年収は<strong>約510万〜580万円</strong>（求人ボックス約510万円、Geekly独自データ約580万円）。受託開発のような納期プレッシャーが比較的小さく残業が少ない傾向があり、育児との両立を重視する女性エンジニアから一貫して人気の高い職種です。ヘルプデスク中心の求人とDX推進など上流を担う求人で年収もキャリアの広がりも大きく違うため、求人の業務範囲の見極めが重要です。詳しくは<a href="/articles/internal-se/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>社内SE転職ガイド</a>へ。
              </p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>⑤ フリーランス：自由度最大、ただし「実務3年」が分岐点</h3>
              <p className="text-sm text-text-light leading-relaxed">
                レバテックフリーランスの公開案件では、SE案件の平均単価は<strong>月72万円（年商換算864万円）</strong>、PM案件88万円、ITコンサル案件102万円。会社員平均を大きく上回る水準ですが、これは「即戦力としてすぐ価値を出せる人」の相場です。目安は実務経験3年以上・設計工程を一人称で担当できること。収入の波、営業・経理の自己管理、出産手当金や育児休業給付が会社員より手薄になる点はライフプランと合わせて検討が必要です。まず副業で1案件回して感触を確かめるのが安全な入り方です。独立準備・案件獲得のコツは<a href="/articles/freelance/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性フリーランスエンジニアガイド</a>で解説しています。
              </p>
            </div>
          </div>
          <p className="text-text-light text-sm mt-3">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>時短期の戦略：「評価が積み上がる業務」に寄せる</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>復帰期の戦略：1〜2年で実績を再蓄積→次の一手</h3>
              <ul className="space-y-2 text-sm text-text-light">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              妊娠・育休・復帰それぞれの実務は<a href="/articles/mama-engineer/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>ママエンジニアの働き方ガイド</a>、出産前後の転職タイミングは<a href="/articles/age-30s/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>30代女性エンジニアの転職ガイド</a>で詳しく解説しています。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              各年代の具体的な転職戦略は<a href="/articles/age-30s/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>30代の転職ガイド</a>を中心に、年収の現在地確認は<a href="/articles/salary-by-age/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>年代別年収ガイド</a>、50代まで見据えた長期戦略は<a href="/articles/long-career-tips/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>長く活躍するためのキャリア戦略</a>をご覧ください。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border bg-white p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>迷ったときの判断基準</h3>
            <ul className="space-y-2 text-sm text-text-light">
      ...
      <section id="sec8" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>ケース1（30代前半・開発エンジニア→PM路線）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                ...
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}>
                  <p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>転換後</p>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>ケース2（30代後半・育休復帰→社内SE経由でマネジメント路線）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}>
                  <p className="text-xs font-bold text-text-light mb-1">転換前</p>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a href="/articles/pm-director/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>PM・Webディレクターへのキャリアチェンジ</h3>
            ...
            <a href="/articles/freelance/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性フリーランスエンジニアガイド</h3>
            ...
            <a href="/articles/long-career-tips/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>長く活躍するためのキャリア戦略</h3>
