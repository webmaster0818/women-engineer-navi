    ...
    <>
      ...
      <section id="sec1" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr>
                  ...
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>86.6%（9割以上が6か月以上取得）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>厚生労働省「令和6年度雇用均等基本調査」</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>男性の育児休業取得率</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>40.5%（過去最高）</td>
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              一方で課題も残ります。男性の育休は約4割が2週間未満の短期取得にとどまり、育児負担が母親側に偏りやすい構造は続いています。だからこそママエンジニア側は、<strong>法制度を正しく知り、両立しやすい職種と企業を選ぶ</strong>ことが重要になります。育休取得率の統計の詳しい読み方は<a href="/articles/maternity-leave-rate/" className="underline" style={{ color: "#0891b2" }}>産休・育休取得率データの記事</a>で解説しています。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>施行時期</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>改正内容</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>ポイント</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2025年4月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>残業免除（所定外労働の制限）の対象拡大</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>3歳未満 → <strong>小学校就学前まで</strong>に拡大</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2025年4月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>子の看護等休暇の拡充</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>対象を<strong>小学3年生修了まで</strong>に延長。感染症による学級閉鎖や入園式・卒園式等も取得理由に追加</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2025年4月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>3歳未満の子を育てる労働者のテレワーク（努力義務）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>テレワークを選択できる措置を講ずることが企業の努力義務に</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2025年4月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>育児時短就業給付金の創設（雇用保険）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>2歳未満の子を育てて時短勤務する被保険者に、<strong>時短中の賃金の原則10%を支給</strong></td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2025年10月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>柔軟な働き方を実現するための措置（義務）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}><strong>3歳〜小学校就学前</strong>の子を育てる労働者向けに、①始業時刻等の変更 ②テレワーク等（月10日以上）③保育施設の設置運営等 ④養育両立支援休暇 ⑤短時間勤務制度——から企業が<strong>2つ以上を用意し、労働者が1つを選択</strong></td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>2025年10月</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>個別の意向聴取・配慮（義務）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>妊娠・出産の申出時や子が3歳になる前に、勤務時間帯や勤務地等に関する労働者の意向を企業が個別に聴取し配慮することが義務に</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>実務上のポイント</h3>
          ...
          <p className="text-text-light leading-relaxed mt-6">
            時短勤務の収入・キャリアへの影響は<a href="/articles/short-time/" className="underline" style={{ color: "#0891b2" }}>時短勤務エンジニアの記事</a>で、産休・育休からの復帰プロセスは<a href="/articles/after-maternity/" className="underline" style={{ color: "#0891b2" }}>産休・育休後のキャリアの記事</a>で詳しく解説しています。
          </p>
        </div>
      </section>
      ...
      <section id="sec3" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>リモート適性</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>時間の読みやすさ</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>両立の観点でのポイント</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Web系開発（バックエンド／フロントエンド）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>◎</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>○</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>フルリモート求人が多く、コード・成果物で評価されるため時短と相性が良い。リリース前は繁忙になりやすい点に注意</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>社内SE・情報システム</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>○</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>◎</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>納期プレッシャーが比較的小さく残業が少ない傾向。社内対応のため出社頻度は企業による</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>QA・テストエンジニア</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>○</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>◎</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>テスト計画に沿って進めやすく、スケジュールが立てやすい。未経験からの入口にもなりやすい</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>インフラ・クラウド（SRE含む）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>○</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>△</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>需要・年収は高いが、障害対応や夜間・休日のオンコール当番の有無を必ず確認</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>SES・客先常駐</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>△（案件次第）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>△</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>働き方が客先のルールに左右される。時短・リモートの可否が案件ごとに変わる点がリスク</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              職種に加えて「働き方の制度」も比較しましょう。両立のしやすさを大きく左右するのは、<strong>フルリモート可否</strong>、<strong>フレックスタイム（特にコアタイムなし）</strong>、<strong>中抜け（送迎時間の離席）の許容</strong>の3つです。フルリモート企業の探し方は<a href="/articles/fullremote-companies/" className="underline" style={{ color: "#0891b2" }}>フルリモート企業の記事</a>にまとめています。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 時短勤務制度の適用期間（法定超えか）</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>4. 子どもの急病時の対応（看護等休暇・在宅切り替え）</h3>
              <p className="text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>5. 育児中社員・女性管理職の在籍状況</h3>
              <p className="text-sm text-text-light">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left w-28" style={{ borderColor: "#d1dce5" }}>時間</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>行動</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>6:00〜8:30</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>起床・朝食・身支度。保育園へ送り（在宅勤務のため送り後すぐ業務に入れる）</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>9:00〜12:00</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>始業。朝会（デイリースタンドアップ）→ 集中して開発タスク。会議は午前〜昼に寄せてもらう調整が効果的</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>12:00〜13:00</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>昼休憩（在宅のため家事を一部済ませることも可能）</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>13:00〜16:00</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>午後の業務。コードレビュー・実装の続き。終業前に進捗をテキストで共有し、チームへの引き継ぎを明確に</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>16:00〜16:30</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>終業（6時間勤務）。保育園へお迎え</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>17:00〜21:00</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>夕食・お風呂・寝かしつけ</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>21:00〜</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>自由時間。余力があれば技術キャッチアップや学習に充てる人も（無理は禁物）</td></tr>
              </tbody>
            </table>
          </div>
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              ポイントは、<strong>在宅勤務によって通勤時間（往復1〜2時間）がそのまま育児・家事・自分の時間に変わる</strong>ことです。テレワーク導入率94.3%のIT業界は、この時間構造を作りやすい点で他業界より有利です。保育園の送迎と仕事の両立の工夫は<a href="/articles/work-childcare-day/" className="underline" style={{ color: "#0891b2" }}>仕事と保育園送迎の1日の記事</a>でさらに詳しく解説しています。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 技術の変化を「差分」で把握する</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 小さなアウトプットを残す</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. 復帰直後の働き方を現実的に設計する</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. 復帰前提のエージェントに相談する</h3>
          ...
          <p className="text-text-light leading-relaxed mt-6">
            復職の具体的なステップは<a href="/articles/return-to-work/" className="underline" style={{ color: "#0891b2" }}>復職・再就職ガイド</a>で、育休復帰後のキャリアの組み立て方は<a href="/articles/after-maternity/" className="underline" style={{ color: "#0891b2" }}>産休・育休後のキャリアの記事</a>で詳しく解説しています。
          </p>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/short-time/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>時短勤務エンジニアガイド</h3>
              <p className="text-sm text-text-light">時短の制度・収入・キャリアへの影響</p>
            </a>
            <a href="/articles/work-childcare-day/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>仕事と保育園送迎の1日</h3>
            ...
            <a href="/articles/maternity-leave-rate/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>産休・育休取得率データ</h3>
            ...
            <a href="/articles/fullremote-companies/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>フルリモート企業ガイド</h3>
            ...
            <a href="/articles/return-to-work/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>復職・再就職ガイド</h3>
