    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. なぜ「フルリモート企業の見極め」が必要なのか</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. “なんちゃってリモート”企業の5つの特徴</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 入社前に確認すべきチェックリスト（一覧表）</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 面接で聞くべき質問（角を立てない聞き方）</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 口コミ・実態情報の集め方（4ステップ）</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. 女性が長く働けるリモート企業の特徴</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. おすすめ転職エージェント</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#0891b2" }}>8. 見極めの成功・失敗事例</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>このガイドで身につく「見極めの目」</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>求人票の「リモート可」の裏にある“本当の出社頻度”を読み解く</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>制度・評価・オンボーディングから「リモートの本気度」を判断する</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>面接や口コミで実態を“裏取り”する具体的な方法を知る</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>女性が長くキャリアを続けられるリモート企業の条件を押さえる</span></li>
              </ul>
            </div>
            <p className="text-sm">
              ※リモート求人全般の探し方は<a href="/articles/remote-jobs/" className="underline" style={{ color: "#0891b2" }}>「女性エンジニアのリモート求人ガイド」</a>、地方在住での働き方は<a href="/articles/regional-remote/" className="underline" style={{ color: "#0891b2" }}>「地方在住エンジニアのリモート転職」</a>もあわせてご覧ください。本記事は「企業選びの目利き」に絞って解説します。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>1. 出社頻度を数字で答えてくれない</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#0891b2" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>2. 制度・手当が一切ない</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>3. 「重要な打ち合わせは出社」が口癖</h3>
              <p className="text-text-light text-sm leading-relaxed">通常はリモートでも、「大事な会議・キックオフ・締めは出社」が前提。“ここぞ”の頻度が読めず、結局は不定期に出社が発生します。</p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#0891b2" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>4. 評価が「勤務時間・在席」ベース</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>5. リモート社員が「最近の入社者だけ」</h3>
              <p className="text-text-light text-sm leading-relaxed">フルリモートで長く働いている先輩がいない・管理職は全員出社。制度が浅く、出社回帰でいつ方針転換されてもおかしくない状態です。</p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#0891b2" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>+α. オンボーディングが「出社前提」</h3>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>何を聞く・見るか</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>安心できる目安</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>出社頻度の実態</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「平均で月に何日出社しますか？」を数字で</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「原則ゼロ／年数回」と即答できる</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>恒久リモートの方針</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>出社回帰の予定・就業規則上の位置づけ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>制度として明文化されている</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>コアタイム／勤務時間</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>フルフレックスか、コアタイムの有無と時間帯</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>コアタイムが短い／中抜けOK</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>評価制度</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>何で評価されるか（成果か、在席時間か）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>目標・成果ベースのMBO等が明確</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>オンボーディング</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>入社直後の研修・OJTがオンライン対応か</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>メンター制度・ドキュメント整備あり</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>コミュニケーション</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Slack/Teams・1on1・非同期文化の有無</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>テキスト文化＋定例1on1が定着</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>リモート手当・環境</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>在宅手当・PC/モニター・通信費補助</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>手当（平均月3,683円目安）や貸与あり</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section id="sec4" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-2" style={{ color: "#0891b2" }}>Q1. 出社頻度の実態を引き出す</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-2" style={{ color: "#7c3aed" }}>Q2. 恒久性・出社回帰の方針を確認</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-2" style={{ color: "#0891b2" }}>Q3. 評価のされ方を聞く</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-2" style={{ color: "#7c3aed" }}>Q4. オンボーディング体制を確認</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-2" style={{ color: "#0891b2" }}>Q5. コミュニケーション文化を聞く</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-2" style={{ color: "#7c3aed" }}>Q6. 女性の両立・復帰実績を確認</h3>
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>口コミを読むときの3つの注意点</h3>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 時短×リモートの両立実績がある</h3>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <p className="text-sm text-text-light leading-relaxed">
              より広い「女性が働きやすい会社」の見極め軸は<a href="/articles/women-friendly-companies/" className="underline" style={{ color: "#0891b2" }}>「女性が働きやすいIT企業の選び方」</a>、自分に合う企業の総合的な選び方は<a href="/articles/how-to-choose/" className="underline" style={{ color: "#0891b2" }}>「失敗しない転職先の選び方」</a>もあわせてご覧ください。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec8" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Cさん（30代・育児中／見極め成功）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">見極めポイント</p><p className="text-sm font-bold">「平均の月出社日数」を数字で確認＋復帰実績を質問</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>結果</p><p className="text-sm font-bold">原則出社ゼロのSaaS企業／時短×フルリモートで両立</p></div>
              </div>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Dさん（20代後半／見極め不足の反省）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">起きたこと</p><p className="text-sm font-bold">「フルリモート可」で入社→実際は週2〜3出社が前提だった</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>その後</p><p className="text-sm font-bold">再転職時に“数字での確認”を徹底し、原則リモート企業へ</p></div>
              </div>
      ...
      <section id="sec10" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/remote-jobs/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアのリモート求人ガイド</h3><p className="text-sm text-text-light">リモート求人全般の探し方と注意点</p></a>
            <a href="/articles/regional-remote/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>地方在住エンジニアのリモート転職</h3><p className="text-sm text-text-light">地方から都心の仕事に就く方法</p></a>
            <a href="/articles/women-friendly-companies/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性が働きやすいIT企業の選び方</h3><p className="text-sm text-text-light">制度・実績で見抜く企業選び</p></a>
            <a href="/articles/work-life-balance/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>エンジニアのワークライフバランス</h3><p className="text-sm text-text-light">両立しながら長く働く工夫</p></a>
          </div>
        </div>
      </section>
