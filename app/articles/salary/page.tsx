        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 女性エンジニアの平均年収【最新データ】</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 年代別の年収相場（男女比較表）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 職種別の年収相場</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 言語・スキル別の年収傾向</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 男女賃金格差の実データ</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. 男女差を埋める3つの具体策</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. 年収1000万円は目指せる？</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>主要データまとめ（2026年6月参照）</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>技術系（IT/通信）の女性平均年収: <strong>419万円</strong>（doda「平均年収ランキング2025」）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>女性SEの平均年収: <strong>約497万円</strong>／男性SE: 約584万円（賃金構造基本統計調査ベース）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>女性全体の平均年収: <strong>370万円</strong>／正社員全体: 429万円（doda）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>ITエンジニア全体（技術系IT/通信）の平均: <strong>469万円</strong>（doda）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>日本のITエンジニアの女性比率: <strong>18.8%</strong>（OECD加盟国中17位。ヒューマンホールディングス調査、2026年6月参照）</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="sec2" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>女性SE</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>男性SE</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>男女差</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>20〜24歳</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約343万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約339万円</td><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5", color: "#0891b2" }}>女性が上回る</td></tr>
                <tr style={{ backgroundColor: "#fff" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>25〜29歳</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約442万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約447万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>ほぼ差なし</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>30〜34歳</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約496万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約546万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約50万円</td></tr>
                <tr style={{ backgroundColor: "#fff" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>35〜39歳</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約506万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約598万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約92万円</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>40〜44歳</td><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5", color: "#7c3aed" }}>約613万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約658万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約44万円</td></tr>
                <tr style={{ backgroundColor: "#fff" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>45〜49歳</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約549万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約670万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約121万円</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>50〜54歳</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約611万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約727万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約116万円</td></tr>
              </tbody>
            </table>
          </div>
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            ...
            <p className="text-sm">
              ※年代ごとの詳しい実額・戦略は <a href="/articles/salary-by-age/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアの年代別年収【20代〜50代】</a> で解説しています。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>プロジェクトマネジャー</td><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5", color: "#7c3aed" }}>707万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>技術系（IT/通信）の職種別1位（doda 2025）。女性が年収を伸ばす王道ルート</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>SRE / クラウドエンジニア</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約660万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>クラウド移行で慢性的に人材不足。リモート求人が多い</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>データサイエンティスト</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約650万円〜</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>AI需要で上昇傾向。スキルにより1,000万円超も</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>セキュリティエンジニア</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約629万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>人材不足で需要安定。資格が評価されやすい</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>ITコンサルタント</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約595万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>最上流。コンサルティングファームではさらに高水準</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>フロントエンドエンジニア</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約523万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>求人が多く、リモート・時短と両立しやすい</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>システムエンジニア / 社内SE</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約516万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>社内SEは残業が少なく両立しやすいと女性に人気</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>バックエンドエンジニア</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約500万〜520万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>スキルが長く通用しブランク復帰しやすい</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>インフラエンジニア</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約497万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>未経験から入りやすい。クラウド/SREへの登竜門</td></tr>
              </tbody>
            </table>
          </div>
          <p className="text-text-light leading-relaxed mt-4 text-sm">
            ※平均年収は各種調査の代表値です。職種ごとの詳しい比較・キャリアの組み立て方は <a href="/articles/salary-by-job/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアの職種別年収比較</a> をご覧ください。
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>年収が上がりやすいスキル</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>掛け合わせで差がつく</h3>
          ...
          <p className="text-text-light leading-relaxed mt-4 text-sm">
            ※言語ごとの年収比較と学習戦略は <a href="/articles/salary-by-language/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアの言語別年収比較</a> で詳しく解説しています。
          </p>
        </div>
      </section>
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>男女差データの要点</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>全産業の男女間賃金格差: <strong>75.8</strong>（過去最小。令和6年賃金構造基本統計調査）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>SEの男女比: 女性約497万円／男性約584万円 = <strong>約85%</strong>（同調査ベースの集計）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>ITエンジニアの格差: <strong>81.7</strong>（男性600万円／女性490万円。Forkwell調査）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>年収800万円以上: 男性23%／<strong>女性4%</strong>（Forkwell調査）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>転職時の昇給額: 男性平均139万円／<strong>女性平均85万円</strong>（Forkwell調査）</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 転職時に必ず年収交渉をする（エージェント経由が確実）</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 高年収職種・上流工程へ職種をずらす</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. 「足りないスキル」に投資し、企業規模・環境も選ぶ</h3>
              <p className="text-sm text-text-light leading-relaxed">
      ...
      <section id="sec7" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p className="text-sm">
              ※具体的な職種・スキル・5つの戦略は <a href="/articles/salary-1000man/" className="font-bold hover:underline" style={{ color: "#0891b2" }}>女性エンジニアが年収1000万を目指す方法</a> で詳しく解説しています。
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/salary-by-age/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアの年代別年収</h3>
            ...
            <a href="/articles/salary-by-job/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアの職種別年収比較</h3>
            ...
            <a href="/articles/salary-by-language/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアの言語別年収比較</h3>
            ...
            <a href="/articles/salary-1000man/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアが年収1000万を目指す方法</h3>
