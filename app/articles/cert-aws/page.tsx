        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. AWS認定資格とは</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. AWS認定の資格体系と難易度（一覧表）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 女性エンジニアにAWS認定が役立つ理由</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. どれから取るべきか（おすすめルート）</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 勉強時間と勉強法（STEP）</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. おすすめ教材・模擬試験</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>AWS認定で証明できること</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>クラウドの基本概念とAWS主要サービス・料金体系の理解（CLF）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>可用性・コスト・セキュリティを考えたアーキテクチャ設計力（SAA）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>サーバーレス・コンテナを使ったアプリ開発（DVA）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>本番環境の運用・監視・自動化（SOA）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>機械学習・ネットワークなど専門領域の高度なスキル（Specialty）</span></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>代表的な認定（略称）</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>想定経験</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>受験料</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Foundational<br />（基礎）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Cloud Practitioner（CLF）<br />AI Practitioner（AIF）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>実務経験不要。学習40〜80時間</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>100USD（約15,000円）</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Associate<br />（中級）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Solutions Architect（SAA）<br />Developer（DVA）<br />SysOps Administrator（SOA）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>1年以上の実務経験が目安</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>150USD（約20,000円）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Professional<br />（上級）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Solutions Architect Professional（SAP）<br />DevOps Engineer（DOP）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>2年以上の高度な実務経験</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>300USD（約40,000円）</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Specialty<br />（専門）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Machine Learning（MLS）<br />Advanced Networking（ANS）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>5年以上の専門的な実務経験</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>300USD（約40,000円）</td>
                </tr>
              </tbody>
            </table>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. スキルを客観的に証明できる</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 自宅・細切れ時間で取得できる</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. ブランク復帰の不安を打ち消せる</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. リモート求人・年収アップに直結</h3>
      ...
      <section id="sec4" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-3 mt-6">
            <div className="rounded-xl border p-6 bg-white" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>未経験・初学者</h3>
            ...
            <div className="rounded-xl border p-6 bg-white" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>転職で評価されたい</h3>
            ...
            <div className="rounded-xl border p-6 bg-white" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>専門を深めたい</h3>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>迷ったらこの判断軸</h3>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>教材例</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>ポイント</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>全体像の把握</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>AWS公式 Cloud Practitioner Essentials（無料）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>公式デジタルトレーニング。まず最初に一周</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>問題演習</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Ping-t / CloudCamp等のWEB問題集</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>無料〜低コストで反復。間違いの解説が要</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>本番形式の模試</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>公式 Practice Question Set / Udemy模試</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>本番の難易度・時間配分に慣れる仕上げ用</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>体系的な参考書</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>CLF-C02対応の市販テキスト・問題集</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>1冊あると安心。読み物として弱点補強に</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>ハンズオン（SAA以上）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>AWS無料利用枠での実機構築</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>設計問題は手を動かすと定着が段違い</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>クラウドエンジニア平均</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約545万〜600万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>IT全体平均（約460万円）を上回る</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>設計・構築層</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>650万〜800万円超</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>SAA/SAPの設計スキルが評価される層</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>ハイクラス層</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>1,000万円以上</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Professional＋豊富な実務経験</td></tr>
                <tr style={{ backgroundColor: "#f8fafb" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>SAA保有の転職効果</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>＋50万〜100万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>転職時の年収アップ例。資格手当の企業も多い</td></tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>年収・キャリアを伸ばす3つのポイント</h3>
            <ul className="space-y-2 text-sm text-text-light">
      ...
      <section id="sec10" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/aws-career/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>AWSエンジニアのキャリアガイド</h3><p className="text-sm text-text-light">資格の先にある仕事内容と年収</p></a>
            <a href="/articles/cloud-gcp-azure/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>GCP・Azureとの比較</h3><p className="text-sm text-text-light">3大クラウドの違いと選び方</p></a>
            ...
            <a href="/articles/sre-devops/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>SRE・DevOpsエンジニア</h3><p className="text-sm text-text-light">AWS認定を活かす次のキャリア</p></a>
          </div>
        </div>
      </section>
