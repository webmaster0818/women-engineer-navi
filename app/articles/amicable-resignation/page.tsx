    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 退職の基本ルール（民法627条と就業規則）</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 退職を切り出すタイミングと伝え方</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 退職交渉の進め方（5STEP）</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 引き止め（カウンターオファー）への対応</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 引き継ぎ・有給消化のすすめ方</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. エンジニア特有の注意点（ソース・権限）</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. 女性がスムーズに退職する工夫</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#0891b2" }}>8. おすすめ転職エージェント</a></li>
              <li><a href="#sec9" className="hover:underline" style={{ color: "#0891b2" }}>9. 円満退職の事例</a></li>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>雇用形態・状況</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>退職できる時期の目安</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>根拠・ポイント</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>無期雇用（正社員）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>申し入れから2週間後</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>民法627条1項。就業規則より優先（承諾不要）</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>月給制で完全月給など</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>当期前半に申し出れば当期末</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>民法627条2項。実務では2週間ルールが優先される場面が多い</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>有期雇用（契約社員）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>原則は契約期間満了まで</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「やむを得ない事由」や勤続1年超で例外あり（民法628条等）</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>円満退職の推奨ライン</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>退職希望日の1ヶ月〜1ヶ月半前</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>引き継ぎ・有給消化を逆算。法律＋社会通念のバランス</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>覚えておきたい3つの権利</h3>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>良いタイミングの例</h3>
              <ul className="space-y-2 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="font-bold">&#10003;</span><span>リリースや大型案件が一段落した直後</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="font-bold">&#10003;</span><span>1on1や定例の後など、上司と話す機会が自然にある時</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="font-bold">&#10003;</span><span>週の前半・午後の落ち着いた時間帯</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="font-bold">&#10003;</span><span>次の職場の内定（入社日）が確定した後</span></li>
              </ul>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#f97066" }}>避けたいタイミング</h3>
              <ul className="space-y-2 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#f97066" }} className="font-bold">&#10007;</span><span>繁忙期・リリース直前（引き継ぎ時間が取れない）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#f97066" }} className="font-bold">&#10007;</span><span>チームに障害・トラブル対応が走っている最中</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#f97066" }} className="font-bold">&#10007;</span><span>上司が多忙で余裕のない朝一・金曜夕方</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#f97066" }} className="font-bold">&#10007;</span><span>内定が出る前に勢いで切り出す</span></li>
              </ul>
            </div>
          </div>
          <div className="rounded-xl border bg-white p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>切り出しの一言・伝え方の型</h3>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>引き止めパターン</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>会社の言い分（例）</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>切り返しの定石</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>年収アップ提案</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「給与を上げるから残ってほしい」</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「金額の問題ではなく、挑戦したい技術領域を変えたいんです」とお金以外の軸で返す</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>ポジション変更</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「異動させる」「リーダーに」</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「以前から相談していれば別ですが、今回は意思が固まっています」と一貫性を示す</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>時期の延期要請</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「人手が足りないから時期をずらして」</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「次の入社日が確定しているので動かせません」と入社日を盾にする</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>情に訴える</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>「君がいないと回らない」</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>感謝を伝えつつ「引き継ぎは責任を持って完了させます」と行動で返す</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>引き止めに負けないための3つの準備</h3>
            <ul className="space-y-2 text-sm text-text-light">
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>引き継ぎドキュメントに含めたい項目</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>担当機能・システムの概要と全体構成（アーキテクチャ図）</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>開発環境の構築手順・ビルド／デプロイ手順</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>設計判断の背景・既知の不具合・運用上の注意点</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>外部サービス／API・連携先・契約や認証情報の所在</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>定常作業・障害対応の手順とエスカレーション先</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>関係者リスト（社内・取引先の連絡窓口）</span></li>
            </ul>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5", backgroundColor: "#ecfeff" }}>
            <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>困ったときの相談先（優先順）</h3>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#f97066" }}>ソースコードは持ち出さない</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>権限・アカウントの棚卸し</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>貸与端末・デバイスの返却</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>誓約書・競業避止は内容を確認</h3>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>転職活動で「実績」を語るときの線引き</h3>
      ...
      <section id="sec9" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Cさん（30代前半・自社開発バックエンド）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">退職交渉の状況</p><p className="text-sm font-bold">退職申し出時に「年収を50万上げる」とカウンターオファー</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>結果</p><p className="text-sm font-bold">入社日を盾に引き止めを辞退／有給20日を全消化して退職</p></div>
              </div>
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Dさん（20代後半・SES／客先常駐）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">退職交渉の状況</p><p className="text-sm font-bold">「常駐先の契約が残っている」と時期の延期を要請される</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>結果</p><p className="text-sm font-bold">民法627条を踏まえつつ余裕ある引き継ぎ計画を提示し合意</p></div>
              </div>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/job-hunting-while-employed/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>在職中の転職活動の進め方</h3><p className="text-sm text-text-light">退職前に次を固める段取り</p></a>
            <a href="/articles/negotiation/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>年収・条件交渉のコツ</h3><p className="text-sm text-text-light">入社日と年収の交渉術</p></a>
            <a href="/articles/schedule/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>転職スケジュールの立て方</h3><p className="text-sm text-text-light">退職日から逆算する計画術</p></a>
            <a href="/articles/career-path/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアのキャリアパス</h3><p className="text-sm text-text-light">次の一歩の選択肢を整理</p></a>
          </div>
        </div>
      </section>
