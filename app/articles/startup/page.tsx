    ...
    <>
      ...
      <section className="relative py-12 md:py-16" style={{ background: "linear-gradient(135deg, #efe3d8 0%, #f4e7da 100%)" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          />
          <div className="mt-4">
            <span className="inline-block rounded-full px-4 py-1 text-sm font-bold text-white" style={{ backgroundColor: "#7c3a55" }}>働き方</span>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8", backgroundColor: "#f0e7dd" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#7c3a55" }}>1. 2026年のスタートアップ市場の現在地【実データ】</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#7c3a55" }}>2. フェーズ別比較表（給与・裁量・リスク・制度）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#7c3a55" }}>3. スタートアップの年収の現実</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#7c3a55" }}>4. ストックオプション（SO）の仕組みを正確に</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#7c3a55" }}>5. 女性視点：産休育休と制度未整備の会社の見極め方</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#7c3a55" }}>6. 大手・Web系との比較と向き不向き</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#7c3a55" }}>7. 転職前に確認すべきポイント</a></li>
      ...
      <section id="sec1" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              働く側にとっての意味はシンプルです。<strong>勢いのあるスタートアップとそうでないスタートアップの差が開いており、「どの会社を選ぶか」の目利きが数年前より重要になった</strong>ということ。後述する資金調達状況の確認方法（<a href="#sec7" className="font-bold hover:underline" style={{ color: "#7c3a55" }}>7章</a>）まで含めて判断材料にしてください。
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-3 mt-6">
            <div className="rounded-xl border p-6 text-center" style={{ borderColor: "#d9c7b8" }}>
              <p className="text-3xl font-bold" style={{ color: "#7c3a55" }}>7,613億円</p>
              <p className="text-sm font-bold mt-2">2025年の国内資金調達総額</p>
              <p className="text-xs text-text-light mt-1">デット除く速報値。前年からほぼ横ばい</p>
            </div>
            <div className="rounded-xl border p-6 text-center" style={{ borderColor: "#d9c7b8" }}>
              <p className="text-3xl font-bold" style={{ color: "#7c3a55" }}>6,240万円</p>
              <p className="text-sm font-bold mt-2">1社あたり調達額の中央値</p>
              <p className="text-xs text-text-light mt-1">前年7,760万円から低下。二極化が進行</p>
            </div>
            <div className="rounded-xl border p-6 text-center" style={{ borderColor: "#d9c7b8" }}>
              <p className="text-3xl font-bold" style={{ color: "#7c3a55" }}>3.1億円</p>
      ...
      <section id="sec2" className="py-10" style={{ backgroundColor: "#f0e7dd" }}>
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#efe3d8" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>給与水準</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>裁量</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>リスク</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>制度の整い度</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>シード〜シリーズA<br /><span className="font-normal text-xs">社員数人〜数十人</span></td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>低め〜同水準。SO比重が大きい</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>最大。技術選定から採用まで関与</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>高い。資金枯渇・事業転換あり</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>未整備が多い。就業規則も最低限</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>シリーズB〜C<br /><span className="font-normal text-xs">社員数十人〜百数十人</span></td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>同水準〜高め。報酬テーブル整備が進む</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>大きいが役割分担が始まる</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>中。次の調達・成長率に依存</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>人事・労務の専任が入り急速に整う</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>レイター〜上場準備<br /><span className="font-normal text-xs">社員百数十人〜</span></td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>大手並みの提示も。SOの妙味は減少</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>チーム単位。専門性で勝負</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>比較的低い。ただし上場延期リスク</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>上場審査対応でほぼ大手並みに整備</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>（参考）大手・上場企業</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>安定。昇給は緩やか</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>限定的。分業が前提</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>低い</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>整備済み。取得実績も豊富</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d9c7b8" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>フェーズ選びの考え方</h3>
            <ul className="space-y-2 text-sm text-text-light">
              ...
              <li>③ <strong>ライフイベントが近い・安定重視</strong> → レイター〜上場準備、または<a href="/articles/web-industry/" className="font-bold hover:underline" style={{ color: "#7c3a55" }}>Web系の中堅以上</a>。制度の運用実績まで確認できる</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="sec3" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              シリーズB以降になると報酬テーブル・等級制度が整備され、資金調達済みの会社は大手と同等以上の提示で人材を採りにきます。<strong>年収を上げる手段としてスタートアップを使うなら、「調達直後の成長企業×需要の高い技術スタック」の組み合わせ</strong>が現実的な狙い目です。年収1,000万円を目指すルート全体は<a href="/articles/salary-1000man/" className="font-bold hover:underline" style={{ color: "#7c3a55" }}>年収1,000万円を目指す方法</a>で整理しています。
            </p>
            <p>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#efe3d8" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>税制適格SOの主な要件</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>内容（令和6年度税制改正反映）</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>付与対象者</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>自社・子会社の取締役・執行役・使用人（大口株主等を除く）。認定を受けた社外高度人材も対象</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>発行形態</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>無償で発行されること</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>権利行使期間</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>付与決議日から2年経過後〜10年以内。<strong>設立5年未満の非上場会社は15年以内</strong>に延長</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>年間の権利行使価額の上限</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}><strong>設立5年未満: 2,400万円／設立5年以上20年未満の非上場会社または上場後5年未満の上場会社: 3,600万円</strong>／それ以外: 1,200万円（令和6年度改正で引き上げ）</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>行使価額</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>契約締結時の1株あたり価額（時価）以上であること</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>譲渡・管理</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>他人への譲渡は禁止。取得株式は証券会社等への保管委託、または令和6年度改正で認められた<strong>発行会社自身による株式管理</strong>が必要</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d9c7b8" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>「一攫千金神話」に流されないためのチェック項目</h3>
            <ul className="space-y-2 text-sm text-text-light">
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d9c7b8" }}>
            <h3 className="text-lg font-bold mb-4" style={{ color: "#7c3a55" }}>制度が未整備な会社で確認すべき6つのポイント</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span><strong>取得実績</strong>：産休・育休を取得した社員（男女とも）が実際にいるか。第1号になる場合は経営陣の考え方を直接聞く</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span><strong>復帰者の有無と働き方</strong>：復帰後に時短・リモートでどう働いているか、具体例を聞く</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span><strong>経営陣の姿勢</strong>：「制度はこれから一緒に作る」と言えるか、ライフイベントを織り込んだ組織設計を考えているか</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span><strong>属人化の度合い</strong>：自分が数か月抜けても回る体制（ドキュメント文化・引き継ぎ）があるか。属人化が極端だと休みにくい</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span><strong>就業規則・社会保険の整備</strong>：就業規則の有無、社会保険・雇用保険への加入は最低限の確認事項</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span><strong>SOと育休の関係</strong>：ベスティングが休業中も進むか、評価・昇給への影響はどう扱われるか</span></li>
            </ul>
          </div>
          <p className="text-text-light leading-relaxed mt-4">
            制度の運用実績まで公表されている企業から選びたい場合は、<a href="/articles/women-friendly-companies/" className="font-bold hover:underline" style={{ color: "#7c3a55" }}>女性が働きやすいIT企業の見つけ方</a>で紹介している「くるみん認定」や女性活躍データベースの活用も有効です。
          </p>
          <p className="text-text-light text-sm mt-3">
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f0e7dd" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            <p>
              スタートアップを検討する人の比較対象は、多くの場合「大手SIer・メーカー系」か「Web系の中堅〜大手」です。Web系業界全体の構造は<a href="/articles/web-industry/" className="font-bold hover:underline" style={{ color: "#7c3a55" }}>Web業界転職ガイド</a>で詳しく解説していますが、スタートアップとの違いを要約すると次の通りです。
            </p>
            <p>
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>スタートアップが向いている人</h3>
              <ul className="space-y-2 text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>大手・Web系中堅以上が向いている人</h3>
              <ul className="space-y-2 text-sm text-text-light">
          ...
          <p className="text-text-light leading-relaxed mt-4">
            なお「まず大手やWeb系で基礎体力をつけ、シリーズB前後のスタートアップに移って裁量を取りに行く」のは王道のキャリア戦略の一つです。長期のキャリア設計は<a href="/articles/career-path/" className="font-bold hover:underline" style={{ color: "#7c3a55" }}>キャリアパス設計ガイド</a>を参考にしてください。
          </p>
        </div>
      </section>
      ...
      <section id="sec7" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mb-6">
            <p>市況が「選別」の局面にあるいま（<a href="#sec1" className="font-bold hover:underline" style={{ color: "#7c3a55" }}>1章</a>）、入社前のデューデリジェンス（自分なりの企業調査）は必須です。最低限、次の5点を確認しましょう。</p>
          </div>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a href="/articles/web-industry/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><h3 className="font-bold mb-1" style={{ color: "#7c3a55" }}>Web業界転職ガイド</h3><p className="text-sm text-text-light">Web系企業の構造とスタートアップとの違い</p></a>
            <a href="/articles/salary-1000man/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><h3 className="font-bold mb-1" style={{ color: "#7c3a55" }}>年収1,000万円を目指す方法</h3><p className="text-sm text-text-light">高年収を実現する現実的なルート</p></a>
            <a href="/articles/women-friendly-companies/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><h3 className="font-bold mb-1" style={{ color: "#7c3a55" }}>女性が働きやすいIT企業の見つけ方</h3><p className="text-sm text-text-light">制度の運用実績を公開データで確認する方法</p></a>
      ...
      <section className="py-12"><div className="mx-auto max-w-4xl px-4 text-center"><div className="rounded-2xl p-8 md:p-12" style={{ background: "linear-gradient(135deg, #7c3a55 0%, #7c3a55 100%)" }}><h2 className="text-2xl font-bold text-white mb-4">理想の転職を実現しましょう</h2><p className="text-white/90 mb-6">まずはエージェントに無料相談。あなたに合ったキャリアプランを一緒に考えましょう。</p><a href="/ranking/" className="inline-block rounded-full px-8 py-4 text-lg font-bold transition-transform hover:scale-105" style={{ backgroundColor: "#c15f47", color: "#ffffff" }}>女性エンジニアにおすすめの転職サイトランキングを見る</a></div></div>
      </section>
    </>
  );
}
