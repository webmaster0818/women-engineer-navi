    ...
    <>
            ...
            <ul className="space-y-3 text-sm leading-relaxed">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  <a href="/articles/ux-designer/" className="underline font-bold" style={{ color: "#0891b2" }}>UXデザイナー転職ガイド</a>
                  へ
                </span>
              </li>
            </ul>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. Webデザイナーという職の現在地（年収・働き方の実態）</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 年収比較：Webデザイナー vs フロントエンド vs UX系職種</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. AIはデザイナーの仕事をどう変えているか</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. デザイナー経験が強みになるエンジニア領域</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. キャリアチェンジの学習ロードマップ</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. キャリアチェンジ後のキャリアパス</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. 転職活動のポイント（女性のキャリア視点）</a></li>
      ...
      <section id="sec1" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              この頭打ちを破るルートは大きく2つあります。1つはアートディレクターやWebディレクターなど<strong>ディレクション側に上がる道</strong>。もう1つが、この記事のテーマである<strong>エンジニア側へ軸足を移す道</strong>です。デザイン制作で培った感覚はUI実装でそのまま活き、エンジニアとしての年収レンジ（後述）に乗り換えられます。また「見た目」より「使いやすさの設計」に関心がある人には<a href="/articles/ux-designer/" className="underline" style={{ color: "#0891b2" }}>UXデザイナーへの転身</a>という第3の道もあります。本記事はエンジニアルートを中心に解説します。
            </p>
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>Webデザイナー年収の実態（要点）</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>平均年収 約423万円・ボリュームゾーン375万〜440万円（求人ボックス）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>doda調査では平均378万円、年収400万円未満が約6割</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>東京都460万円 vs 地方最低342万円と地域差が大きい（求人ボックス）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>年収を上げる主ルートは「ディレクション側」か「エンジニア側」への展開</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="sec2" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>年収レンジ・備考</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Webデザイナー</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約423万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>分布309万〜834万円。ボリュームゾーン375万〜440万円。東京都460万円</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>フロントエンドエンジニア</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約446万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>分布336万〜971万円。東京都474万円。在宅ワーク条件の求人は全体比+20%程度</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>UXデザイナー</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約404万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>UXリサーチャーなど上流・専門職は538万〜631万円</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>UI/UXデザイナー（参考: Indeed調査）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>648万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>事業会社の専門職中心の集計（2025年10月時点）。実装を含む上位層は高水準</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>この表の読み方</h3>
          ...
          <p className="text-text-light leading-relaxed mt-4">
            エンジニア職種全体の年収比較は<a href="/articles/salary-by-job/" className="underline" style={{ color: "#0891b2" }}>職種別年収ガイド</a>で詳しく解説しています。
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#f97066" }}>縮小する仕事</h3>
              <p className="text-text-light text-sm leading-relaxed">
                バナーの量産、テンプレート的なLP制作、デザインカンプの単純コーディング。AIが「最初の70%」を担う領域で、発注者自身がAIツールで試作できるようになり、単価と件数の両方に下押し圧力がかかっています。
              </p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>価値が上がる仕事</h3>
              <p className="text-text-light text-sm leading-relaxed">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. UI実装の品質</h3>
              <p className="text-text-light text-sm leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. デザインシステムの構築・運用</h3>
              <p className="text-text-light text-sm leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. デザイナーとエンジニアの橋渡し</h3>
              <p className="text-text-light text-sm leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. AI活用の目利き</h3>
              <p className="text-text-light text-sm leading-relaxed">
          ...
          <p className="text-text-light leading-relaxed mt-6">
            主戦場となるフロントエンドエンジニアの仕事内容・年収・将来性は<a href="/articles/frontend/" className="underline" style={{ color: "#0891b2" }}>フロントエンドエンジニア転職ガイド</a>で詳しく解説しています。
          </p>
        </div>
      </section>
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mb-6">
            <p>
              Webデザイナーは「HTMLとCSSに触れたことがある」「Webの仕組みを肌感覚で知っている」分、完全未経験よりスタート地点が前にあります。1日2〜3時間の学習で<strong>半年〜1年</strong>が目安です。プログラミング学習全般の進め方は<a href="/articles/beginner/" className="underline" style={{ color: "#0891b2" }}>未経験からエンジニアになる完全ガイド</a>も参考にしてください。
            </p>
          </div>
          ...
          <p className="text-text-light leading-relaxed mt-6">
            STEP3のReact/TypeScriptは求人数・年収の両面で投資効果が最も高い領域です。具体的な学習手順は<a href="/articles/typescript-react/" className="underline" style={{ color: "#0891b2" }}>TypeScript×Reactエンジニアへの道</a>で解説しています。
          </p>
        </div>
      </section>
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>フロントエンドを極める</h3>
      ...
      <section className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a href="/articles/ux-designer/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>UXデザイナー転職ガイド</h3>
            ...
            <a href="/articles/typescript-react/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>TypeScript×Reactエンジニアへの道</h3>
