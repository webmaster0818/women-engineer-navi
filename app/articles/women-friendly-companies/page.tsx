    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          >
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#7c3a55" }}>1. ランキングではなく「認定×公開データ」で見極める理由</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#7c3a55" }}>2. 4つの公的認定制度の比較（えるぼし・くるみん・なでしこ銘柄・健康経営優良法人）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#7c3a55" }}>3. 厚労省「女性の活躍推進企業データベース」の使い方</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#7c3a55" }}>4. 公開データの読み方：5つの指標と判断基準</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#efe3d8" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>認定・選定</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>根拠・主体</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>何を評価するか</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>規模感・確認先</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>えるぼし／プラチナえるぼし</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>女性活躍推進法・厚生労働省</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>採用・継続就業・労働時間・女性管理職比率・多様なキャリアコースの5基準。<strong>女性のキャリアが伸びる会社か</strong></td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>えるぼし約3,800社・プラチナ約100社（2025年9月末時点）。厚労省DBで検索可</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>くるみん／プラチナくるみん</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>次世代育成支援対策推進法・厚生労働省</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>育休取得率・労働時間など。<strong>子育てと仕事を両立できる会社か</strong>。不妊治療両立の「プラス」認定もあり</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>くるみん約5,000社・プラチナ約770社（2025年時点）。厚労省サイトに都道府県別一覧</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>なでしこ銘柄</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>経済産業省×東京証券取引所</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>女性活躍を<strong>経営戦略として実践する上場企業</strong>を毎年選定。共働き・共育て支援の「Nextなでしこ」も併設</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>令和6年度は23社＋Nextなでしこ16社（2025年3月発表）。経産省サイトで公表</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>健康経営優良法人</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>経済産業省設計・日本健康会議認定</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>従業員の健康管理を経営課題として実践しているか。<strong>女性の健康支援も評価項目</strong>。大規模部門の上位は「ホワイト500」</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>毎年更新制。経産省・ACTION!健康経営ポータルで認定法人を公表</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>キャリアアップ重視なら「えるぼし」</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>育児との両立重視なら「くるみん」</h3>
              <p className="text-text-light text-sm leading-relaxed">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#efe3d8" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>判断の目安</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d9c7b8" }}>読み方のポイント</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>① 女性管理職比率</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>課長級の全産業平均12.3%が基準線。20%以上は高水準</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>現状値より「目標＋期限を公表しているか」が本気度のサイン。<a href="/articles/women-manager/" className="underline" style={{ color: "#7c3a55" }}>女性管理職のキャリア解説</a>も参照</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>② 育休取得率・復帰率</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>女性取得率はほぼ100%が標準。差がつくのは「復帰率」と「男性取得率」</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>復帰率90%以上＋男性取得率が高い企業は、両立が「お互いさま」の文化。<a href="/articles/maternity-leave-rate/" className="underline" style={{ color: "#7c3a55" }}>産休育休復帰率の詳細</a>へ</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>③ 男女間賃金差異</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>男性賃金に対する女性賃金の割合。全労働者・正規・非正規の3区分で公表</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>差が大きい場合、女性が上位職に少ない・勤続が短い等の構造を示唆。注記の説明まで読む</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>④ 平均継続勤務年数の男女差</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>男女差が小さい（女性が男性並みに長い）ほど、出産後も辞めずに続けられている証拠</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>女性だけ極端に短い企業は、両立の壁がある可能性。離職率と合わせて確認</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>⑤ 働き方の柔軟性</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>リモートワーク実施率・フレックス・残業時間・有給取得率</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>「制度あり」ではなく「実施率・取得率」の実績数値を公開している企業を選ぶ。<a href="/articles/fullremote-companies/" className="underline" style={{ color: "#7c3a55" }}>フルリモート企業の探し方</a>も参考に</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d9c7b8" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>データを読むときの3原則</h3>
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>SCSK（採用サイト データ集・ニュースリリース）</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>富士通（統合レポート・サステナビリティデータ）</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>NTTデータグループ（DEIページ・行動計画）</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>NTT（なでしこ銘柄選定）</h3>
              <p className="text-sm text-text-light leading-relaxed">
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f0e7dd" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mb-6">
            <p>
              公開データで一次スクリーニングをしたら、求人票と面接で「運用実態」を確かめます。育児と両立しながら働く先輩の実情は<a href="/articles/mama-engineer/" className="underline" style={{ color: "#7c3a55" }}>ママエンジニアの働き方ガイド</a>も参考にしてください。
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#7c3a55" }}>求人票で確認する6項目</h3>
              <ul className="space-y-3 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>えるぼし・くるみん等の認定マークの記載があるか（厚労省DBで裏取り）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>リモート・フレックスが「制度あり」ではなく頻度・条件まで書かれているか</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>育休の「取得実績」「復帰実績」の数値が書かれているか</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>時短勤務の対象期間（法定の3歳までか、小学校卒業までかなど）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>みなし残業の有無と平均残業時間の実績値</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>「女性活躍中」だけで具体データがない求人は要注意（イメージ訴求のみの可能性）</span></li>
              </ul>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#7c3a55" }}>面接での逆質問6選</h3>
              <ul className="space-y-3 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>「配属予定チームでの直近の育休取得・復帰の事例を教えてください」</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>「時短勤務中の方の評価・昇給はどのように行われていますか」</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>「リモートと出社の実際の割合はどのくらいですか」</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>「女性のエンジニアリングマネージャーやテックリードはいらっしゃいますか」</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>「急な子どもの発熱などの際、チームはどう対応していますか」</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>「行動計画の女性管理職目標に対する進捗はいかがですか」（公開値を踏まえた質問は熱意も伝わる）</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>落とし穴1：認定がない＝働きにくい、ではない</h3>
              <p className="text-text-light text-sm leading-relaxed">
                認定申請には事務負担がかかるため、実態が整っていても申請しないスタートアップ・中小Web系企業は多数あります。認定の有無は入口のスクリーニングにとどめ、未認定企業は公開データと面接で個別に確認しましょう。
              </p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>落とし穴2：くるみん＝キャリアも伸びる、ではない</h3>
              <p className="text-text-light text-sm leading-relaxed">
                くるみんが評価するのは両立支援です。「辞めずに働き続けられる」ことと「昇進・昇給の機会が平等にある」ことは別問題。キャリアアップも狙うなら、えるぼしの認定段階と女性管理職比率を併せて確認しましょう。
              </p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>落とし穴3：全社データと配属部署のギャップ</h3>
              <p className="text-text-light text-sm leading-relaxed">
                公開データは全社平均です。エンジニア部門だけ見ると女性比率や残業時間が大きく異なることもあります。面接では「配属予定の部門・チーム」の実態を必ず確認してください。
              </p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>落とし穴4：自力の情報収集には限界がある</h3>
              <p className="text-text-light text-sm leading-relaxed">
                制度の運用実態や社内の雰囲気は、外からは検証しきれません。女性のキャリアに詳しい転職エージェントは過去の転職者のフィードバックを蓄積しており、求人票に載らない情報源として有効です。選び方は<a href="/articles/how-to-choose/" className="underline" style={{ color: "#7c3a55" }}>エージェントの選び方ガイド</a>で解説しています。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          <h2 className="text-2xl font-bold mb-6">キャリア・職場環境の記事一覧</h2>
          <div className="grid gap-3 md:grid-cols-2">
            <a href="/articles/career-path/" className="block rounded-xl border bg-white p-4 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><p className="text-sm font-bold" style={{ color: "#7c3a55" }}>キャリアパス完全マップ｜5つの方向性</p></a>
            <a href="/articles/long-career-tips/" className="block rounded-xl border bg-white p-4 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><p className="text-sm font-bold" style={{ color: "#7c3a55" }}>長く働き続けるコツ</p></a>
            <a href="/articles/harassment/" className="block rounded-xl border bg-white p-4 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><p className="text-sm font-bold" style={{ color: "#7c3a55" }}>職場のハラスメント対処ガイド</p></a>
            <a href="/articles/success-stories/" className="block rounded-xl border bg-white p-4 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><p className="text-sm font-bold" style={{ color: "#7c3a55" }}>転職成功パターン分析</p></a>
            <a href="/articles/community/" className="block rounded-xl border bg-white p-4 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><p className="text-sm font-bold" style={{ color: "#7c3a55" }}>コミュニティ・勉強会一覧</p></a>
            <a href="/articles/work-abroad/" className="block rounded-xl border bg-white p-4 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><p className="text-sm font-bold" style={{ color: "#7c3a55" }}>海外転職ガイド</p></a>
          </div>
        </div>
      </section>
