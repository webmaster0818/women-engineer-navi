    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl p-6" style={{ backgroundColor: "#ecfeff", border: "2px solid #0891b2" }}>
            ...
            <ul className="space-y-2 text-sm text-text-light">
              ...
              <li>・迷ったら、技術を深めるか管理へ進むかの比較は<a href="/articles/long-career-tips/" className="underline" style={{ color: "#0891b2" }}>長く働くためのキャリア戦略</a>も参考に</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. PM・PdM・Webディレクターの違い（整理表）</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 年収相場（職種別・出典付き）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. エンジニアからPMへの移行ルート</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 必要なスキルと資格（PMP）</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 調整業務とライフイベント両立の実態</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. 求人動向と将来性</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. PM転職で評価されるポイント</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#0891b2" }}>8. おすすめ転職エージェント</a></li>
              <li><a href="#sec9" className="hover:underline" style={{ color: "#0891b2" }}>9. PM・ディレクターのその先のキャリア</a></li>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>PM（プロジェクトマネジャー）</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>PdM（プロダクトマネージャー）</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>Webディレクター</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>責任の対象</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>プロジェクトのQCD（品質・コスト・納期）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>プロダクトの価値・事業成果（KPI）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>Webサイト・コンテンツの品質と進行</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>主な仕事</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>計画立案・工数見積もり・進捗/リスク管理・顧客折衝</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>ユーザー調査・ロードマップ策定・優先順位の意思決定</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>要件整理・制作チームの進行管理・品質チェック</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>平均年収の目安</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>707万円（doda 2025）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約774万円（求人ボックス集計）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約495万円（求人ボックス）</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>向いている人</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>段取り・リスク察知・関係者調整が得意な人</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>データと仮説検証が好きで「何を作るか」を考えたい人</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>マルチタスクが得意で制作物のクオリティにこだわれる人</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>未経験からの入りやすさ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>低（開発・リーダー経験が前提になりやすい）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>低（エンジニア/PM/マーケ等からの転向が中心）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>中（アシスタントディレクターから入る道がある）</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>プロジェクトマネジャー（PM）</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>707万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>doda 2025。IT/通信系技術職1位。求人ボックス集計では約692万円</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>プロダクトマネージャー（PdM）</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>約774万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>求人ボックス集計。業界調査では年収600万〜899万円が約46%のボリュームゾーン、1,000万円以上も2割超</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>Webディレクター</td>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>約495万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>求人ボックス。年収幅は303万〜917万円と広く、経験で大きく伸びる</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>（参考）ITエンジニア全体</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>469万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>doda 2025。IT/通信系技術職全体の平均</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>（参考）正社員全体</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>429万円</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>doda 2025。3年連続で上昇し過去8年間の最高値</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>年収データの読み方</h3>
            <ul className="space-y-2 text-sm text-text-light">
              <li>① <strong>PMはIT技術職の年収トップ</strong>。エンジニアからの転向は年収アップの王道ルート（職種別の比較は<a href="/articles/salary-by-job/" className="underline" style={{ color: "#0891b2" }}>職種別年収ランキング</a>を参照）</li>
              <li>② <strong>PdMはさらに上振れしやすい</strong>。シニアPdMや外資系SaaSでは1,000万円超も珍しくなく、<a href="/articles/salary-1000man/" className="underline" style={{ color: "#0891b2" }}>年収1,000万円への道</a>に最も近い職種のひとつ</li>
      ...
      <section id="sec3" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>PdM・Webディレクターへのルート</h3>
            <ul className="space-y-2 text-sm text-text-light">
              ...
              <li>・社内での昇進ルート（EM・管理職）と迷う場合は<a href="/articles/women-manager/" className="underline" style={{ color: "#0891b2" }}>女性エンジニアの管理職キャリアガイド</a>を、より上流のコンサル職は<a href="/articles/it-consultant/" className="underline" style={{ color: "#0891b2" }}>女性ITコンサルタント転職ガイド</a>を参照してください。</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>計画・進行管理</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>WBS・工数見積もり・スケジュール管理・アジャイル/スクラム</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>PMの中核。アジャイル経験はWeb系で特に評価が高い</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>ステークホルダー調整</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>顧客折衝・社内調整・合意形成・交渉</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>利害が対立する関係者の落とし所を作る力。面接で具体例を問われる</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>リスク・品質管理</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>リスクの早期検知・課題管理・品質基準の設定</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>エンジニア出身者の強みが最も活きる領域</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>ドキュメント・可視化</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>要件定義書・議事録・進捗レポート・ダッシュボード</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>リモート時代のPMは「書いて伝える力」が生命線</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>データ・事業理解（PdM寄り）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>KPI設計・SQL/BIツール・ユーザーインタビュー</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>PdMを目指すなら必須。PMからの差別化要素</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>代表的な資格: PMPとプロジェクトマネージャ試験</h3>
            <ul className="space-y-2 text-sm text-text-light">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>両立しやすい要素</h3>
              <ul className="space-y-2 text-sm text-text-light">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>注意すべき要素と対策</h3>
              <ul className="space-y-2 text-sm text-text-light">
          ...
          <p className="text-text-light leading-relaxed mt-6 text-sm">
            産休・育休後の復帰やブランクからの再開を含めた長期戦略は<a href="/articles/long-career-tips/" className="underline" style={{ color: "#0891b2" }}>女性エンジニアが長く働くためのキャリア戦略</a>で詳しく解説しています。
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>1. 規模と役割を数字で語れること</h3>
              <p className="text-sm text-text-light">「何人チームを・何カ月・どの工程で」率いたか。小規模でも、責任範囲が明確な経験は高く評価されます。</p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>2. トラブル対応の具体例</h3>
              <p className="text-sm text-text-light">遅延・仕様変更・メンバー離脱にどう対処したか。面接で最も深掘りされる定番の質問です。</p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>3. 技術がわかること</h3>
              <p className="text-sm text-text-light">見積もりの妥当性判断・技術的リスクの察知は、エンジニア出身PMの最大の差別化要素です。</p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>4. 体系的な知識（PMP等）</h3>
      ...
      <section id="sec9" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>大規模PM・PMO</h3>
              <p className="text-sm text-text-light">より大きな予算・人数のプロジェクトへ。大手SIerや事業会社のPMO組織で、年収800万〜1,000万円台を狙う道。</p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>PdM・プロダクト責任者</h3>
              <p className="text-sm text-text-light">「作り方」から「何を作るか」へ軸足を移す道。CPO・VPoPなどプロダクト組織の責任者は<a href="/articles/salary-1000man/" className="underline" style={{ color: "#0891b2" }}>年収1,000万円超</a>も視野に入ります。</p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>管理職（EM・部門長）</h3>
              <p className="text-sm text-text-light">プロジェクト単位から組織のマネジメントへ。詳しくは<a href="/articles/women-manager/" className="underline" style={{ color: "#0891b2" }}>女性エンジニアの管理職キャリアガイド</a>を参照。</p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>ITコンサルタント</h3>
              <p className="text-sm text-text-light">PM経験はコンサル転職の有力な武器。より上流の戦略・構想策定へ進む道は<a href="/articles/it-consultant/" className="underline" style={{ color: "#0891b2" }}>女性ITコンサルタント転職ガイド</a>で解説しています。</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a href="/articles/it-consultant/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性ITコンサルタント転職ガイド</h3>
            ...
            <a href="/articles/salary-by-job/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>IT職種別の年収ランキング</h3>
            ...
            <a href="/articles/salary-1000man/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}>
              <h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>年収1,000万円への道</h3><p className="text-sm text-text-light">マネジメント職で目指す高年収</p>
            </a>
          </div>
        </div>
      </section>
