    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 社内SEとは（仕事内容）</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 社内SEが女性に人気の理由</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 必要なスキルと資格</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 社内SEの年収相場（年代別）</a></li>
              ...
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. 社内SEのキャリアパス</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>社内SEの主な担当領域</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>社内インフラ構築・保守（サーバー / ネットワーク / クラウド）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>ヘルプデスク（PC・アカウント・トラブル対応、社内問い合わせ）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>業務システムの導入・運用（勤怠 / 会計 / 販売・在庫管理 / SaaS）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>ベンダー管理（外注先の選定・進捗管理・要件のとりまとめ）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>DX推進（ペーパーレス化・業務自動化・クラウド移行・データ活用）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>情報セキュリティ・社内ルール整備</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 残業が少なくWLBが良好</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 自社に腰を据えて長く働ける</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. コミュニケーション力が活きる</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. リモート・フレックスも広がる</h3>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <p className="text-sm text-text-light leading-relaxed">
              <strong style={{ color: "#7c3aed" }}>注意：</strong>人気職ゆえに「楽すぎる」というイメージが先行しがちですが、情シスの人員が少ない企業では一人に負担が集中することも。求人を選ぶ際は<strong>残業の実態・人員体制・産休育休の取得実績</strong>を必ず確認しましょう。
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>ITの基礎知識</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>ネットワーク / サーバー / OS / セキュリティ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>幅広い領域の全体像を理解。深さより広さが大切</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>業務システム・SaaS</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>勤怠 / 会計 / 販売管理 / Microsoft 365 / Salesforce</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>導入・設定・運用の経験が即戦力になる</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>コミュニケーション・調整力</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>要件ヒアリング / ベンダー折衝 / 社内説明</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>社内SE最大の評価ポイント。文系・事務出身の強み</td>
                </tr>
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>クラウド・DXツール</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>AWS / Azure / Google Workspace / RPA / kintone</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>DX推進の中心。扱えると市場価値・年収が上がる</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>おすすめ資格</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>ITパスポート / 基本情報技術者 / 応用情報技術者</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>未経験はITパスポート→基本情報で基礎を証明</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="overflow-x-auto mt-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>20代</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約450万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>運用・ヘルプデスク中心。経験を積む時期</td></tr>
                <tr style={{ backgroundColor: "#fff" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>30代</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約550万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>設計・プロジェクト推進を任され始める</td></tr>
                <tr><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>40代</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>約600万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>企画・管理層。50歳前後で約760万円が最高水準</td></tr>
                <tr style={{ backgroundColor: "#fff" }}><td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>マネージャー / 情シス責任者</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>800万〜1000万円</td><td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>IT戦略・DXを主導。ハイクラス層は平均826万円の調査も</td></tr>
              </tbody>
            </table>
          </div>
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
      ...
      <section id="sec7" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}><h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>マネジメントへ</h3><p className="text-sm text-text-light">情シスリーダー → ITマネージャー → 情報システム部長／CIO。IT戦略を主導し年収800万〜1000万円も狙える道。</p></div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}><h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>DX・企画の専門家</h3><p className="text-sm text-text-light">DX推進担当／ITコンサル寄りへ。業務改善・データ活用・生成AI導入を主導する希少人材として市場価値を高める道。</p></div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}><h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>技術を深める</h3><p className="text-sm text-text-light">インフラ／クラウド／セキュリティのスペシャリストへ。専門領域を持つことで安定して長く働ける道。</p></div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}><h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>働き方を軸にする</h3><p className="text-sm text-text-light">残業少なめ・リモート可の社内SEを軸に、ライフステージに合わせて腰を据えて働く。長く安定したキャリアを築く道。</p></div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Cさん（30代前半・SES→社内SE）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">転職前</p><p className="text-sm font-bold">SESの客先常駐エンジニア / 年収430万円・残業多め</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>転職後</p><p className="text-sm font-bold">メーカーの社内SE（情シス）/ 年収520万円・残業月10時間</p></div>
              </div>
            ...
            <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Dさん（20代後半・事務職→社内SE）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">転職前</p><p className="text-sm font-bold">営業事務（社内システム担当を兼務）/ 年収330万円</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>転職後</p><p className="text-sm font-bold">IT企業の社内SE（ヘルプデスク＋業務システム）/ 年収420万円</p></div>
              </div>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/work-life-balance/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアのワークライフバランス</h3><p className="text-sm text-text-light">残業少なめで長く働ける職場の選び方</p></a>
            <a href="/articles/sier-industry/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>SIer業界 転職ガイド</h3><p className="text-sm text-text-light">社内SEとの違いと働き方を比較</p></a>
            <a href="/articles/women-friendly-companies/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性が働きやすいIT企業の見極め方</h3><p className="text-sm text-text-light">産休育休・復帰実績のチェックポイント</p></a>
