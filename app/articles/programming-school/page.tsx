    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl p-6" style={{ backgroundColor: "#ecfeff", border: "2px solid #0891b2" }}>
            ...
            <ul className="space-y-2 text-sm text-text-light leading-relaxed">
              ...
              <li className="flex items-start gap-2">
                <span style={{ color: "#0891b2" }} className="mt-0.5 font-bold">&#10003;</span>
                <span><strong>無料の公的選択肢</strong>もあります。求職者支援制度（無料訓練＋条件を満たせば月10万円の給付金）や、<a href="/articles/tokyo-women-training/" className="underline" style={{ color: "#0891b2" }}>東京都の女性ITエンジニア育成事業</a>（受講料無料・6か月・就職支援つき）が代表です。</span>
              </li>
              <li className="flex items-start gap-2">
                <span style={{ color: "#0891b2" }} className="mt-0.5 font-bold">&#10003;</span>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>独学で足りる可能性が高い人</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>スクール（または公的訓練）が向く人</h3>
              <ul className="space-y-2 text-sm text-text-light">
          ...
          <div className="space-y-4 text-text-light leading-relaxed mt-6">
            <p>
              迷ったら、<strong>「まず無料〜低コストで1〜2か月独学し、続いたら本格投資を判断する」</strong>のが失敗の少ない順序です。適性確認の前に数十万円の契約をするのは順序が逆です。未経験からの学習手順全体は<a href="/articles/beginner/" className="underline" style={{ color: "#0891b2" }}>未経験から女性エンジニアになるロードマップ</a>で詳しく解説しています。また、実務経験者がブランク明けに学び直す場合は、ゼロから学ぶスクールよりも「差分のキャッチアップ」が効率的です（<a href="/articles/return-to-work/" className="underline" style={{ color: "#0891b2" }}>ブランクからの復職ガイド</a>参照）。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec2" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>選択肢</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>費用の目安</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>期間の目安</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>向く人・注意点</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold bg-white" style={{ borderColor: "#d1dce5" }}>独学</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d1dce5" }}>書籍・学習サイトで<strong>月数千円程度〜</strong></td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d1dce5" }}>6か月〜1年（週10時間前後の学習を想定）</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d1dce5" }}>自走できる人。費用最小・自由度最大だが、挫折率と「何を学ぶべきか迷う時間」が最大のコスト</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>民間プログラミングスクール</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>短期講座は数万円台〜、転職支援付き長期コースは<strong>数十万円規模</strong>が一般的。<strong>給付対象講座なら最大80%支給</strong>で実質負担を大幅に下げられる</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>1か月〜6か月程度（コースによる）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>質問環境・強制力・転職支援に投資したい人。講座の質・転職支援の中身の差が大きく、<strong>選び方（後述7項目）が成否を分ける</strong></td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold bg-white" style={{ borderColor: "#d1dce5" }}>公的職業訓練<br />（ハロートレーニング・自治体事業）</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d1dce5" }}><strong>受講料無料</strong>（テキスト代等は自己負担）。求職者支援制度なら条件を満たせば<strong>月10万円の給付金</strong>も</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d1dce5" }}>2〜6か月程度（コースによる）</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d1dce5" }}>離職中・費用をかけられない人。募集期間・定員・選考があり、開講時期を自分で選べない点と、コース内容が求人ニーズと合うかの確認が必要</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>組み合わせも有効</h3>
            <p className="text-sm text-text-light leading-relaxed">
              3択のどれか1つに決める必要はありません。「独学で基礎文法→公的訓練やスクールで実践と転職支援」「スクールで学びつつ国家試験の<a href="/articles/cert-kihonjoho/" className="underline" style={{ color: "#0891b2" }}>基本情報技術者試験</a>を並行して客観的な基礎力を証明する」など、組み合わせることで費用対効果を高められます。東京都在住で条件が合う方は、無料で訓練＋就職支援を一体で受けられる<a href="/articles/tokyo-women-training/" className="underline" style={{ color: "#0891b2" }}>女性ITエンジニア育成事業</a>を先に検討する価値があります。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec3" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr>
                  ...
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>受講費用の50%（年間上限40万円）を受講中に支給。資格取得して1年以内に就職等で70%、さらに賃金が5%以上上昇すると<strong>最大80%（年間上限64万円）</strong>。IT分野では経産大臣認定の「第四次産業革命スキル習得講座（Reスキル講座）」のうち厚労大臣指定の講座などが対象</td>
                ...
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  ...
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>特定一般は受講費用の40%（資格取得して就職等で<strong>最大50%</strong>）、一般は20%を支給。短期・入門レベルの講座はこちらが対象のことが多い</td>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>キャリア相談＋IT等の講座受講＋転職支援を一体提供。受講修了で費用の50%（上限40万円）、転職して1年継続でさらに20%（上限16万円）＝<strong>最大70%・上限56万円</strong>。事業は令和8年度末まで継続予定</td>
                ...
                <tr style={{ backgroundColor: "#f8fafb" }}>
                  ...
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}><strong>無料の職業訓練</strong>（テキスト代等除く）を受講でき、本人収入月8万円以下・世帯収入月25万円以下などの条件を満たせば<strong>月10万円の職業訓練受講給付金</strong>＋通所手当を支給</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>雇用保険を受給できない離職者（長期離職後の再就職者・専業主婦からの再就職など）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>東京都「女性ITエンジニア育成事業」<br />（東京都）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}><strong>受講料無料・PCレンタル無料</strong>。eラーニング主体＋月2回の集合型訓練（6か月）と就職支援を一体提供。託児サービスあり。詳細は<a href="/articles/tokyo-women-training/" className="underline" style={{ color: "#0891b2" }}>解説記事</a>を参照</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>原則39歳以下の女性で、求職中または非正規雇用で就業中、都内IT企業等への正社員就職を希望する方</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>給付金活用の3ステップ</h3>
            <ul className="space-y-2 text-sm text-text-light">
          ...
          <p className="text-text-light leading-relaxed mt-6 text-sm">
            離職中で雇用保険を受給できない方は求職者支援制度＋ハローワーク、在職中で転職前提の方は経産省リスキリング支援、本格的な長期講座なら専門実践教育訓練給付、と<strong>自分の就業状態から逆引きする</strong>のが早道です。ブランクからの学び直しに使う場合の制度比較は<a href="/articles/return-to-work/" className="underline" style={{ color: "#0891b2" }}>復職ガイドの支援制度の章</a>でも解説しています。
          </p>
        </div>
      </section>
      ...
      <section id="sec4" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>1. 給付金の対象講座か（実質負担がまったく変わる）</h3>
              <p className="text-sm text-text-light leading-relaxed">
                前章の通り、専門実践教育訓練給付の対象なら最大80%、経産省リスキリング支援なら最大70%の支援があります。厚生労働省の教育訓練講座検索システムで講座単位で確認を。対象外の高額講座を選ぶ合理的な理由があるかを自問しましょう。
              </p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>2. 「転職成功率」の分母と定義（誇大広告の最重要チェック）</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>3. 転職支援の中身（「支援あり」の一言で済ませない）</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>4. 総額・支払い方法・中途解約の条件</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>5. カリキュラムが「成果物」につながるか</h3>
              <p className="text-sm text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3aed" }}>6. 質問環境とメンターの体制</h3>
              <p className="text-sm text-text-light leading-relaxed">
                スクールに払う費用の大部分は「質問できる環境」への対価です。質問への回答時間帯と速度、メンターは現役エンジニアか、担当は固定か毎回変わるか、を確認。育児や仕事と両立する場合は、夜間・休日の質問対応やレッスン振替の柔軟さが完走率を左右します。
              </p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#0891b2" }}>7. 必要な学習時間と自分の生活の整合</h3>
              <p className="text-sm text-text-light leading-relaxed">
          ...
          <div className="rounded-xl p-6 mt-6" style={{ backgroundColor: "#fff7ed", border: "2px solid #f97066" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#f97066" }}>こんな勧誘・広告には立ち止まる</h3>
            <ul className="space-y-2 text-sm text-text-light">
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. カリキュラム＋αの「自分の作品」を作る</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 客観的な基礎力の証明を並行する</h3>
              <p className="text-sm text-text-light">
                スクールの修了証は採用市場での通用度にばらつきがありますが、国家試験は評価が安定しています。<a href="/articles/cert-kihonjoho/" className="underline" style={{ color: "#0891b2" }}>基本情報技術者試験</a>を学習と並行すれば、コンピュータサイエンスの土台が固まり、未経験採用の書類選考でも基礎力の客観証明になります。
              </p>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. 転職活動はスクールの紹介求人「だけ」に頼らない</h3>
              <p className="text-sm text-text-light">
                スクールや訓練の紹介求人は選択肢の一部に過ぎません。IT特化型・女性特化型の転職エージェントを併用すれば、未経験可・研修体制あり・産休育休実績ありといった軸で求人を比較できます。エージェントは無料で利用でき、応募先の幅が広がるほど「学んだスキルを活かせる企業」に出会う確率は上がります。応募〜内定の全体像は<a href="/articles/beginner/" className="underline" style={{ color: "#0891b2" }}>未経験転職ロードマップ</a>を参照してください。
              </p>
            </div>
          </div>
        </div>
