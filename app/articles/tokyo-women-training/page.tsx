    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl p-6" style={{ backgroundColor: "#efe3d8", border: "2px solid #7c3a55" }}>
            ...
            <p className="text-xs text-text-light mt-4">
              出典: <a href="https://women-tokyo-en.metro.tokyo.lg.jp/" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "#7c3a55" }}>令和8年度女性ITエンジニア育成事業 公式サイト</a>（2026年7月8日参照）
            </p>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8", backgroundColor: "#f0e7dd" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#7c3a55" }}>1. 女性ITエンジニア育成事業とは</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#7c3a55" }}>2. 事業概要表（対象者・期間・費用・内容・申込）</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#7c3a55" }}>3. 2つのコース内容（プログラミング／インフラクラウド）</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#7c3a55" }}>4. 費用は無料？自己負担になるもの</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#7c3a55" }}>5. 申込方法と受講までのステップ</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#7c3a55" }}>6. 口コミ・評判の調べ方と応募前のチェックポイント</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#7c3a55" }}>7. 向いている人・向いていない人</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#7c3a55" }}>8. 事業終了後の転職活動の進め方</a></li>
      ...
      <section id="sec1" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              「都の事業」という安心感に加え、訓練（スキル習得）と就職支援（キャリアカウンセリング〜職業紹介）がセットになっている点が、独学や一般的な<a href="/articles/programming-school/" className="underline" style={{ color: "#7c3a55" }}>プログラミングスクール</a>との大きな違いです。
            </p>
          </div>
        </div>
      </section>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-text-light">
                <tr>
                  ...
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d9c7b8" }}>女性ITエンジニア育成事業（東京都産業労働局）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>対象者</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>原則39歳以下の女性／求職中または非正規雇用で就業中（申込時点で正社員でない方）／都内のIT関連企業等への正社員就職を希望する方／学生でない方</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold bg-white" style={{ borderColor: "#d9c7b8" }}>コース</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d9c7b8" }}>プログラミングコース（約148時間）／インフラクラウドコース（約142時間）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>期間・形式</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>6か月。eラーニング主体＋月2回の集合型訓練（新宿会場）。託児サービスあり（事前予約制・定員あり）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold bg-white" style={{ borderColor: "#d9c7b8" }}>費用</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d9c7b8" }}>受講料無料・PCレンタル無料（交通費・資格受験費用は自己負担）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>就職支援</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>キャリアアドバイザーによるカウンセリング、履歴書・職務経歴書作成サポート、面接対策、職業紹介・マッチング</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold bg-white" style={{ borderColor: "#d9c7b8" }}>申込方法</td>
                  <td className="border px-4 py-3 bg-white" style={{ borderColor: "#d9c7b8" }}>公式サイト（women-tokyo-en.metro.tokyo.lg.jp）から申込。期ごとに募集（2026年6月時点: 前期2期生は2026年7月1日開始・申込期限6月24日）</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d9c7b8" }}>運営・問い合わせ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d9c7b8" }}>アデコ株式会社（東京都から受託）／運営事務局 0120-630-023（火〜金 10:00〜18:00、土 10:00〜17:00）</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>プログラミングコース</h3>
              <ul className="space-y-2 text-sm text-text-light mb-4">
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>学習時間の目安: 約148時間</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>内容: 基礎知識／Web制作（HTML・CSS）／Java／開発演習／試験対策</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>Java・Web系の開発エンジニアを目指す人向け</span></li>
              </ul>
              <p className="text-sm text-text-light leading-relaxed">Javaは業務システムやWebサービスで広く使われる言語で、求人数が多いのが特徴。開発職に進みたい人の標準的な入口です。</p>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>インフラクラウドコース</h3>
              <ul className="space-y-2 text-sm text-text-light mb-4">
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>学習時間の目安: 約142時間</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>内容: 基礎知識／サーバ基礎／クラウド（AWS）／構築演習／試験対策</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>サーバー・クラウド領域のインフラエンジニアを目指す人向け</span></li>
              </ul>
          ...
          <p className="text-text-light leading-relaxed mt-6 text-sm">
            どちらのコースにも試験対策が含まれています。IT全般の土台を固めたい人は、国家試験である<a href="/articles/cert-kihonjoho/" className="underline" style={{ color: "#7c3a55" }}>基本情報技術者試験</a>の学習を並行すると、訓練内容の理解も転職時のアピールも強くなります。
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              ...
              <ul className="space-y-2 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>受講料（eラーニング・集合型訓練とも）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>パソコンのレンタル</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>就職支援（カウンセリング・書類添削・面接対策・職業紹介）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>託児サービス（集合型訓練時・事前予約制・定員あり）</span></li>
              </ul>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#c15f47" }}>自己負担のもの</h3>
              <ul className="space-y-2 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#c15f47" }} className="mt-1 font-bold">&#8226;</span><span>集合型訓練（新宿会場・月2回）への交通費</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#c15f47" }} className="mt-1 font-bold">&#8226;</span><span>資格を受験する場合の受験費用</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#c15f47" }} className="mt-1 font-bold">&#8226;</span><span>自宅学習用の通信環境などの生活インフラ</span></li>
              </ul>
            </div>
          </div>
          <p className="text-xs text-text-light mt-4">
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f0e7dd" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border bg-white p-6 mt-6" style={{ borderColor: "#d9c7b8" }}>
            <h3 className="text-lg font-bold mb-4" style={{ color: "#7c3a55" }}>応募前に公式で確認したい7つのチェックポイント</h3>
            <ul className="space-y-3 text-sm text-text-light">
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">1.</span><span><strong>学習時間を確保できるか</strong> — 約142〜148時間／6か月。週6時間前後の継続が必要</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">2.</span><span><strong>月2回、新宿に通えるか</strong> — 集合型訓練は新宿会場。交通費は自己負担</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">3.</span><span><strong>託児の空き状況</strong> — 事前予約制・定員ありのため、育児中の人は早めに確認</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">4.</span><span><strong>どちらのコースが自分の志向に合うか</strong> — 開発（Java/Web）かインフラ（サーバ/AWS）か</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">5.</span><span><strong>目指せる資格と受験費用</strong> — 試験対策は含まれるが受験料は自己負担</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">6.</span><span><strong>職業紹介で扱う求人の傾向</strong> — どんな企業への紹介実績があるかを事務局に質問</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">7.</span><span><strong>申込期限と次の期の予定</strong> — 期ごとに募集が締め切られるため、逃した場合の次回も確認</span></li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="sec7" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3a55" }}>向いている人</h3>
              <ul className="space-y-2 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>39歳以下で、都内のIT企業に正社員として就職したい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>スクール費用をかけずに体系的な訓練を受けたい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>非正規で働きながら、eラーニング中心で学びたい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>託児サービスを使いながら学習時間を確保したい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3a55" }} className="mt-1 font-bold">&#10003;</span><span>学習だけでなく就職支援まで伴走してほしい</span></li>
              </ul>
            </div>
            <div className="rounded-xl border p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#c15f47" }}>別の選択肢を検討したほうがよい人</h3>
              <ul className="space-y-2 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#c15f47" }} className="mt-1 font-bold">&#8226;</span><span>現在正社員の人（申込時点で正社員でないことが条件）→ 在職のまま学ぶなら<a href="/articles/reskilling-leave/" className="underline" style={{ color: "#7c3a55" }}>リスキリング休暇・社内制度の活用</a>や民間スクールを検討</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#c15f47" }} className="mt-1 font-bold">&#8226;</span><span>40歳以上の人（原則39歳以下）→ 東京都の他の職業訓練や教育訓練給付つきの<a href="/articles/programming-school/" className="underline" style={{ color: "#7c3a55" }}>プログラミングスクール</a>を検討</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#c15f47" }} className="mt-1 font-bold">&#8226;</span><span>都外での就職を希望する人（都内IT関連企業等への就職希望が条件）</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#c15f47" }} className="mt-1 font-bold">&#8226;</span><span>今すぐ転職したい人 → 訓練6か月を待たず、<a href="/articles/beginner/" className="underline" style={{ color: "#7c3a55" }}>未経験からのITエンジニア転職ガイド</a>を参考にポテンシャル採用を狙う方法も</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="sec8" className="py-10" style={{ backgroundColor: "#f0e7dd" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3a55" }}>1. 学習成果を「見せられる形」にする</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3a55" }}>2. 事業の職業紹介＋転職エージェントを併用する</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d9c7b8" }}>
              <h3 className="text-lg font-bold mb-2" style={{ color: "#7c3a55" }}>3. 東京のIT求人市場を把握する</h3>
              <p className="text-sm text-text-light leading-relaxed">本事業は都内IT企業への就職が前提です。東京の求人動向・年収相場・働きやすい企業の見極め方は<a href="/articles/tokyo/" className="underline" style={{ color: "#7c3a55" }}>東京の女性エンジニア転職ガイド</a>で詳しく解説しています。</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <a href="/articles/cert-kihonjoho/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d9c7b8" }}><h3 className="font-bold mb-1" style={{ color: "#7c3a55" }}>基本情報技術者試験ガイド</h3><p className="text-sm text-text-light">ITの土台を証明する国家資格</p></a>
      ...
      <section className="py-10" style={{ backgroundColor: "#f0e7dd" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <ul className="space-y-2 text-sm text-text-light">
            <li>出典: 東京都「令和8年度女性ITエンジニア育成事業」公式サイト <a href="https://women-tokyo-en.metro.tokyo.lg.jp/" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "#7c3a55" }}>https://women-tokyo-en.metro.tokyo.lg.jp/</a>（2026年6月参照）</li>
            <li>出典: TOKYOはたらくネット「女性ITエンジニア育成事業」 <a href="https://www.hataraku.metro.tokyo.lg.jp/kyushokusha-kunren/etc/jyosei_en/index.html" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "#7c3a55" }}>https://www.hataraku.metro.tokyo.lg.jp/kyushokusha-kunren/etc/jyosei_en/index.html</a>（2026年6月参照）</li>
            <li>出典: アデコ株式会社「東京都の令和7年度『女性ITエンジニア育成事業』の運営を開始」 <a href="https://www.adeccogroup.jp/pressroom/2025/0501_03" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "#7c3a55" }}>https://www.adeccogroup.jp/pressroom/2025/0501_03</a>（2026年6月参照）</li>
            <li>出典: 株式会社ワークポート「東京都の『女性ITエンジニア育成事業』を受託」 <a href="https://www.workport.co.jp/corporate/news/detail/891.html" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "#7c3a55" }}>https://www.workport.co.jp/corporate/news/detail/891.html</a>（2026年6月参照）</li>
          </ul>
        </div>
      </section>
