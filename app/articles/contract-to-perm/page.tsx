    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-xl border p-6" style={{ borderColor: "#d1dce5", backgroundColor: "#f8fafb" }}>
            ...
            <ol className="space-y-2 text-sm">
              <li><a href="#sec1" className="hover:underline" style={{ color: "#0891b2" }}>1. 契約社員エンジニアの実態</a></li>
              <li><a href="#sec2" className="hover:underline" style={{ color: "#0891b2" }}>2. 正社員登用と無期転換ルール（5年）の違い</a></li>
              <li><a href="#sec3" className="hover:underline" style={{ color: "#0891b2" }}>3. 正社員になる具体ステップ</a></li>
              <li><a href="#sec4" className="hover:underline" style={{ color: "#0891b2" }}>4. 契約社員のメリット・デメリット</a></li>
              <li><a href="#sec5" className="hover:underline" style={{ color: "#0891b2" }}>5. 「正社員転職」という選択肢</a></li>
              <li><a href="#sec6" className="hover:underline" style={{ color: "#0891b2" }}>6. 女性が安定を得るための戦略</a></li>
              <li><a href="#sec7" className="hover:underline" style={{ color: "#0891b2" }}>7. おすすめ転職エージェント</a></li>
              <li><a href="#sec8" className="hover:underline" style={{ color: "#0891b2" }}>8. 正社員化の成功事例</a></li>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>契約社員エンジニアが「正社員」を意識し始めるタイミング</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>契約更新のたびに「次も続くか」不安を感じるようになった</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>結婚・出産・住宅ローンなど、長期の安定が必要になった</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>正社員と同じ業務なのに賞与・退職金がない待遇差に気づいた</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>実務経験が貯まり、技術的に正社員ポジションを狙える自信がついた</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>通算5年（無期転換の申込権）が近づいてきた</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>(1) 無期転換ルール（5年ルール）</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>(2) 正社員登用制度</h3>
              <p className="text-text-light text-sm leading-relaxed">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#ecfeff" }}>
                  ...
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>無期転換ルール</th>
                  <th className="border px-4 py-3 text-left" style={{ borderColor: "#d1dce5" }}>正社員登用制度</th>
                </tr>
              </thead>
              <tbody className="text-text-light">
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>根拠</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>法律上の権利（労働契約法）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>会社が任意で設ける制度</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>条件</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>通算5年超＋本人の申込み</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>登用試験・面接・推薦などの選考</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>会社の拒否</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>不可（要件を満たせば権利発生）</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>選考で不合格はあり得る</td>
                </tr>
                <tr style={{ backgroundColor: "#fff" }}>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>変わるもの</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>契約期間（無期化）のみ</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>賞与・退職金・昇給・福利厚生など待遇全般</td>
                </tr>
                <tr>
                  <td className="border px-4 py-3 font-bold" style={{ borderColor: "#d1dce5" }}>主な効果</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>雇い止めの不安が消える</td>
                  <td className="border px-4 py-3" style={{ borderColor: "#d1dce5" }}>収入・福利厚生が正社員水準に</td>
                </tr>
              </tbody>
            </table>
          </div>

          <div className="rounded-xl border p-6 mt-8 bg-white" style={{ borderColor: "#7c3aed" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>注意：無期転換＝正社員ではない</h3>
          ...
          <div className="rounded-xl border p-6 mt-6 bg-white" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>同一労働同一賃金も味方になる</h3>
            <p className="text-sm text-text-light leading-relaxed">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              ...
              <ul className="space-y-3 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>勤務日数・時間を調整しやすく、育児・介護と両立しやすい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>転勤・異動が少なく、特定の技術領域に集中できる</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>マネジメントや調整業務を任されにくく、開発に専念しやすい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>未経験・ブランクからでも現場に入りやすい入口になる</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>同一労働同一賃金で、不合理な待遇差は是正の対象</span></li>
              </ul>
            </div>
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#7c3aed" }}>デメリット</h3>
              <ul className="space-y-3 text-sm text-text-light">
                <li className="flex items-start gap-2"><span style={{ color: "#7c3aed" }} className="mt-1 font-bold">&#9888;</span><span>契約満了で雇用が終わる可能性があり、雇い止めの不安がある</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3aed" }} className="mt-1 font-bold">&#9888;</span><span>賞与・退職金が支給されないことが多く、生涯収入で差が出やすい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3aed" }} className="mt-1 font-bold">&#9888;</span><span>昇給・昇進の機会が限られ、キャリアの上限を感じやすい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3aed" }} className="mt-1 font-bold">&#9888;</span><span>住宅ローンなど社会的信用の審査で不利になりやすい</span></li>
                <li className="flex items-start gap-2"><span style={{ color: "#7c3aed" }} className="mt-1 font-bold">&#9888;</span><span>産休育休は取得可だが、更新・復帰ポジションに不安が残りやすい</span></li>
              </ul>
            </div>
          </div>
      ...
      <section id="sec5" className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="rounded-xl border p-6 mt-6" style={{ borderColor: "#d1dce5" }}>
            <h3 className="text-lg font-bold mb-4" style={{ color: "#0891b2" }}>正社員転職を選んだほうがよいサイン</h3>
            <ul className="space-y-3 text-sm text-text-light">
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>今の会社に正社員登用制度がない、または過去の登用実績がほぼない</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>無期転換しても賞与・退職金が正社員と同水準にならない見込み</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>産休育休の取得実績や時短勤務の運用が、今の会社では不安</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>すでに2〜3年以上の実務経験があり、即戦力として通用する</span></li>
              <li className="flex items-start gap-2"><span style={{ color: "#0891b2" }} className="mt-1 font-bold">&#10003;</span><span>年収を大きく上げたい・リモートなど働き方を選びたい</span></li>
            </ul>
          </div>
          <p className="text-text-light leading-relaxed mt-6 text-sm">
      ...
      <section id="sec6" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>1. 「技術の資産化」で雇用形態に縛られない</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>2. 「安定」と「待遇」を分けて考える</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#0891b2" }}>3. 産休育休・時短の「実績」で会社を選ぶ</h3>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#7c3aed" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>4. リモート・成果評価の環境を優先する</h3>
          ...
          <div className="mt-8 rounded-xl p-6" style={{ backgroundColor: "#ecfeff", border: "1px solid #0891b2" }}>
            <p className="text-sm text-text-light leading-relaxed">
              <strong style={{ color: "#0891b2" }}>まとめると</strong>――「今すぐ安定が必要なら無期転換＋登用」「待遇と環境を一気に変えたいなら正社員転職」。どちらの道でも、契約社員で積んだ技術経験が交渉力になります。自分の市場価値を一度客観的に評価してもらい、最適なルートを選びましょう。
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sec8" className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Cさん（30代前半・社内登用で正社員へ）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">転職前</p><p className="text-sm font-bold">自社サービス企業の契約社員（PHP）/ 年収380万円・賞与なし</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>転職後</p><p className="text-sm font-bold">同社の正社員（登用試験合格）/ 年収500万円・賞与・退職金あり</p></div>
              </div>
            ...
            <div className="rounded-xl border bg-white p-6" style={{ borderColor: "#d1dce5" }}>
              <h3 className="text-lg font-bold mb-3" style={{ color: "#7c3aed" }}>Dさん（20代後半・正社員転職を選択）</h3>
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div className="rounded-lg p-3" style={{ backgroundColor: "#f8fafb" }}><p className="text-xs font-bold text-text-light mb-1">転職前</p><p className="text-sm font-bold">受託開発の契約社員（Java）/ 年収360万円・登用実績ほぼなし</p></div>
                <div className="rounded-lg p-3" style={{ backgroundColor: "#ecfeff" }}><p className="text-xs font-bold mb-1" style={{ color: "#0891b2" }}>転職後</p><p className="text-sm font-bold">SaaS企業の正社員バックエンド / 年収480万円・フルリモート</p></div>
              </div>
      ...
      <section className="py-10" style={{ backgroundColor: "#f8fafb" }}>
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <a href="/articles/career-path/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性エンジニアのキャリアパス</h3><p className="text-sm text-text-light">長く働き続けるための進路設計</p></a>
            ...
            <a href="/articles/women-friendly-companies/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>女性が働きやすい企業の選び方</h3><p className="text-sm text-text-light">産休育休・復帰率で見極める</p></a>
            <a href="/articles/resume-guide/" className="block rounded-xl border bg-white p-5 transition-shadow hover:shadow-md" style={{ borderColor: "#d1dce5" }}><h3 className="font-bold mb-1" style={{ color: "#0891b2" }}>職務経歴書の書き方ガイド</h3><p className="text-sm text-text-light">契約社員の経験を正社員転職で活かす</p></a>
          </div>
        </div>
      </section>
